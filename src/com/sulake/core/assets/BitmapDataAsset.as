package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_556:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_556 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_121 is BitmapDataAsset)
         {
            ...
            this.var_1514 = BitmapDataAsset(this.var_121).var_1514;
            this.var_1513 = BitmapDataAsset(this.var_121).var_1513;
            if(this._bitmap != null)
            {
               this.var_121 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1514 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1513 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
