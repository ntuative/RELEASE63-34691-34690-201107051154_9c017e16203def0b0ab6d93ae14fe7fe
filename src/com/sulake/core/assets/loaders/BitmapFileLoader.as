package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1143 = param2 == null ? "" : param2.url;
         this._type = param1;
         ...
         {
            this.var_44.load(param2,this.var_1144);
         }
      }
      ...
      {
         this.var_1143 = param1.url;
         var_360 = 0;
         this.var_44.load(param1,this.var_1144);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_360 < var_3049)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1143 + (this.var_1143.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_360),this.var_1144);
               return true;
            }
         }
         return false;
