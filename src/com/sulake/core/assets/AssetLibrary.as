package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1229:String = "AssetLibraryReady";
      
      public static const const_866:String = "AssetLibraryLoaded";
      
      public static const const_1776:String = "AssetLibraryUnloaded";
      
      public static const const_1911:String = "AssetLibraryLoadError";
      
      private static const const_711:String = "name";
      
      private static const const_1111:String = "asset";
      
      private static const const_1110:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1109:String = "library";
      
      private static var var_342:Dictionary;
      
      private static var var_2031:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_568:uint = 0;
      
      private static var var_1059:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_568;
         this.var_472 = new Dictionary(false);
         this.var_569 = new Dictionary(false);
         this.var_1061 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_694 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1109);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1111);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_711);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1110);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_694 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1059.splice(var_1059.indexOf(this),1);
            --var_568;
            this.var_569 = null;
            this.var_1061 = null;
            this.var_183 = null;
      ...
      {
         if(this.var_694 == param1.url && this.var_1058)
         {
            if(!this.var_1060 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_695);
            }
      ...
      public function unload() : void
      {
         ...
         this.var_1058 = false;
         this.var_694 = null;
         dispatchEvent(new Event(AssetLibrary.const_1776));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1061[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_569[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1256,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1218,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1331,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1166,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_569[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_569[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_473;
                     this.var_471.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_569[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_471.length ? this.getAssetByName(this.var_471[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_183)
         {
            ...
            {
               return this.var_471.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_183[param1] != null || (this.var_695 != null ? this.var_695[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               ++this.var_473;
               this.var_471.push(param1);
            }
            this.var_183[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2031.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_183)
            {
               if(this.var_183[_loc2_] == param1)
               {
                  this.var_471.splice(this.var_471.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_342.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_342[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_472.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_472[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_342[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_472[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_342)
            {
               _loc3_ = AssetTypeDeclaration(var_342[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_472)
         {
            _loc3_ = AssetTypeDeclaration(this.var_472[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_342)
            {
               _loc4_ = AssetTypeDeclaration(var_342[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_472)
         {
            _loc4_ = AssetTypeDeclaration(this.var_472[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_695 = _loc2_.resource;
         this.var_694 = _loc2_.url;
         if(this.var_1060)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_695);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1911));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1109);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1111);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_711) && _loc3_.attribute(const_711).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_694 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_695[param1]);
                     _loc6_ = _loc3_.child(const_1110);
