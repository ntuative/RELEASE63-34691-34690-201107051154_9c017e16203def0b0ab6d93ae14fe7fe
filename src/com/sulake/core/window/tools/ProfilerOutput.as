package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1656:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1657:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_187:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3091 = new Array();
         this.var_187 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1656() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_187)
         {
            this.var_187.removeStopEventListener(this.refresh);
            this.var_187 = null;
         }
         if(!this.var_187 && param1)
         {
            this.var_187 = param1;
            this.var_187.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_603)
            {
               this.var_2137 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_187.getProfilerAgentsInArray();
         ...
         if(this.var_2137)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_187.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_187.numBitmapAssetInstances + " / " + this.var_187.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_187.numTrackedBitmapDataInstances + " / " + this.var_187.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1657() as ByteArray;
