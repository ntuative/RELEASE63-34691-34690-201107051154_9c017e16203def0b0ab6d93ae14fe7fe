package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_463:String = "_BTN_TEXT";
      
      protected static const const_1409:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_463);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_263:
                  try
                  {
                     getChildByName(const_463).blend = getChildByName(const_463).blend + const_1409;
                  }
                  catch(e:Error)
                  {
                  }
