package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_512)
         {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_890:
                  ...
                  break;
               case PropertyDefaults.const_1019:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_512)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_890,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1748);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1268)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1019,param1.toolTipDelay,PropertyStruct.const_305,true));
         }
         else
         {
      ...
      {
         this.var_1417 = param1 == null ? "null" : param1;
      }
