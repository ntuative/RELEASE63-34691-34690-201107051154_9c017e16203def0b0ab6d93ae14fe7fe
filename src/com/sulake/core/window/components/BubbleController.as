package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2098:String = "_POINTER_UP";
      
      private static const const_2096:String = "_POINTER_DOWN";
      
      private static const const_2099:String = "_POINTER_LEFT";
      
      private static const const_2097:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_865;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_916,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1866);
         }
         if(this.var_865 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_784,this.var_865,PropertyStruct.const_38,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_916:
                  ...
                  break;
               case PropertyDefaults.const_784:
