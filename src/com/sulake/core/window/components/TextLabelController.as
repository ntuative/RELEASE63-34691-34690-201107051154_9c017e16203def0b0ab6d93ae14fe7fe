package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_371:Object = null;
      ...
      {
         return this.var_371 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_456);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_371 != null)
            {
               _loc1_.textColor = uint(this.var_371);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_456 != param1.name)
         {
            this.var_456 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2395 = _loc2_.textWidth;
         this.var_2396 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_371 != _loc2_.color : this.var_371 != null && this.var_371 != PropertyDefaults.const_822) ? new PropertyStruct(PropertyDefaults.const_399,this.var_371,PropertyStruct.const_174,true) : PropertyDefaults.const_1341);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_736)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,this.var_41.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_1013);
            }
            if(this.var_41.top != PropertyDefaults.const_1021)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_41.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_751);
            }
            if(this.var_41.right != PropertyDefaults.const_944)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_288,this.var_41.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_846);
            }
            if(this.var_41.bottom != PropertyDefaults.const_994)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_287,this.var_41.bottom,PropertyStruct.const_38,true));
            }
            else
            {
