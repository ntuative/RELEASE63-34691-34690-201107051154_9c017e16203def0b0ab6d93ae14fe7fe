package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1026:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_840:String;
      
      private var var_1270:String = null;
      
      private var var_1972:StyleSheet = null;
      ...
      {
         this.var_840 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1270 == param2)
         {
            return;
         }
         param1.var_1270 = param2;
         param1.var_1972 = null;
         if(param1.var_1270 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1270);
            param1.var_1972 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_882.indexOf(param1) > -1)
         {
            this.var_840 = param1;
         }
      }
      ...
      {
         return this.var_840 == LinkTarget.const_31 ? defaultLinkTarget : this.var_840;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1972;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1235)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_840 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_912,this.var_840,PropertyStruct.const_51,true,PropertyDefaults.const_882));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1808);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_912)
            {
               this.var_840 = _loc2_.value as String;
               break;
            }
