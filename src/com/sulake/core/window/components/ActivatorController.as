package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_321)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1385)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_936;
         if(this.var_936 != param1)
         {
            if(this.var_936 != null)
            {
               if(!this.var_936.disposed)
               {
                  this.var_936.deactivate();
               }
            }
            this.var_936 = param1;
