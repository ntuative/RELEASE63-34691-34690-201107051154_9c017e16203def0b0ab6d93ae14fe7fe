package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_608 != PropertyDefaults.const_1374)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_862,this.var_608,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1795);
         }
         if(this.var_937 != PropertyDefaults.const_1398)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_818,this.var_937,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_818:
                  this.var_937 = _loc2_.value as String;
                  break;
            }
         }
