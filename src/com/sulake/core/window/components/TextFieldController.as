package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1701:uint = 500;
      
      protected var var_1417:String = "";
      
      protected var var_1421:Boolean = false;
      
      protected var var_813:Boolean = false;
      ...
      {
         this.var_1417 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1164,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_813 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_184,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_441,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_370,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_116,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_778,false,PropertyStruct.const_37,true) : PropertyDefaults.const_2013);
         _loc1_.push(this.var_1421 != PropertyDefaults.const_1360 ? new PropertyStruct(PropertyDefaults.const_851,this.var_1421,PropertyStruct.const_37,true) : PropertyDefaults.const_1861);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1210 ? new PropertyStruct(PropertyDefaults.const_996,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1961);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1202 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1788);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_851:
                  this.var_1421 = _loc2_.value as Boolean;
                  if(this.var_1421)
                  {
               ...
               case PropertyDefaults.const_996:
                  ...
                  break;
               case PropertyDefaults.const_778:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1330:
