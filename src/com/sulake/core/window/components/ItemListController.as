package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2248:Boolean = false;
      
      protected var var_602:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_746:Number = -1.0;
      
      protected var var_749:Number = -1.0;
      
      protected var var_1141:Boolean = true;
      
      protected var var_504:Boolean = false;
      
      protected var var_1411:Boolean = false;
      
      protected var var_2247:int = 0;
      
      protected var var_2246:int = 0;
      
      protected var var_1412:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_429,WindowStyle.const_105,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_458,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_158,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_225,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1411;
      }
      ...
      {
         return new Rectangle(this.var_748 * this.maxScrollH,this.var_747 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_748)
         {
            this.var_748 = param1;
            this._container.x = -this.var_748 * this.maxScrollH;
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_747)
         {
            this.var_747 = param1;
            this._container.y = -this.var_747 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_574,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_492,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_627,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_458,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_158,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_225,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2247 = _loc3_;
               this.var_2246 = _loc4_;
               this.var_1412 = 0;
               this.var_1414 = 0;
               this.var_1413 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1413)
               {
                  this.var_1412 = this.var_2247 - _loc3_;
                  this.var_1414 = this.var_2246 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1412 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1412 / this.var_125;
                     }
                  }
                  else if(this.var_1414 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1414 / this.var_108;
                  }
                  this.var_2247 = _loc3_;
                  this.var_2246 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_303:
               if(this.var_1413)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1412,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1414);
                  }
                  this.var_1413 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1141 && !this.var_602 && this._container)
         {
            this.var_602 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_924)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_444,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1265);
         }
         if(this.var_1141 != PropertyDefaults.const_1377)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_889,this.var_1141,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1947);
         }
         if(this.var_504 != PropertyDefaults.const_1319)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_831,this.var_504,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1915);
         }
         if(this.var_1411 != PropertyDefaults.const_1217)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_808,this.var_1411,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1799);
         }
         if(this.var_746 != PropertyDefaults.const_1181)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_783,this.var_746,PropertyStruct.const_132,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2024);
         }
         if(this.var_749 != PropertyDefaults.const_1318)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_858,this.var_749,PropertyStruct.const_132,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_444:
                  ...
                  break;
               case PropertyDefaults.const_831:
               ...
               case PropertyDefaults.const_889:
                  this.var_1141 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_783:
                  this.var_746 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_858:
