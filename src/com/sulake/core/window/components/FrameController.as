package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1532:String = "_TITLE";
      
      private static const const_1723:String = "_HEADER";
      
      private static const const_1722:String = "_CONTENT";
      
      private static const const_1724:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1693:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1532) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1693 = findChildByTag(const_1723) as IHeaderWindow;
            if(!this.var_1693)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1722) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1724) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1407,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1146 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_383);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_281);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_293);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_281,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_281,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_293,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_293,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_347,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,_loc3_.left,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,_loc3_.top,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_288,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_287,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         return _loc1_;
      }
