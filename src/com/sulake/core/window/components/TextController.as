package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1410:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_934:Number;
      ...
      private var var_456:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_456,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_456 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_456,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_213);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_968 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_456);
      }
      ...
      {
         this.var_934 = param1;
         this._field.scrollH = this.var_934 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_934 * this.maxScrollH,this.var_607 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_456);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_774,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1232));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1292 ? new PropertyStruct(PropertyDefaults.const_901,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1230) : PropertyDefaults.const_2037);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_174,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_51,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_305,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1393 ? new PropertyStruct(PropertyDefaults.const_1198,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1382) : PropertyDefaults.const_1791);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_822) ? new PropertyStruct(PropertyDefaults.const_399,this._field.textColor,PropertyStruct.const_174,true) : PropertyDefaults.const_1341);
         _loc1_.push(this.var_456 != TextStyleManager.const_213 ? new PropertyStruct(PropertyDefaults.const_405,this.var_456,PropertyStruct.const_51,true,PropertyDefaults.const_763) : PropertyDefaults.const_1231);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_736 ? new PropertyStruct(PropertyDefaults.const_268,this.var_41.left,PropertyStruct.const_38,true) : PropertyDefaults.const_1013);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_1021 ? new PropertyStruct(PropertyDefaults.const_260,this.var_41.top,PropertyStruct.const_38,true) : PropertyDefaults.const_751);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_944 ? new PropertyStruct(PropertyDefaults.const_288,this.var_41.right,PropertyStruct.const_38,true) : PropertyDefaults.const_846);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_994 ? new PropertyStruct(PropertyDefaults.const_287,this.var_41.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_802);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1325 ? new PropertyStruct(PropertyDefaults.const_956,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_2012);
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_51,this._field.restrict != null));
