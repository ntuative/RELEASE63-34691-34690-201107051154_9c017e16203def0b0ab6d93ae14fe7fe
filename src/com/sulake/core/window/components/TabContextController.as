package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1434:String = "_SELECTOR";
      
      private static const const_1433:String = "_CONTENT";
       
      
      protected var var_1142:ITabSelectorWindow;
      
      protected var var_2249:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1142 = findChildByTag(const_1434) as ITabSelectorWindow;
            if(this.var_1142 != null)
            {
               this.var_1142.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2249 == null)
         {
            this.var_2249 = findChildByTag(const_1433) as IWindowContainer;
         }
      ...
      {
         return !!this.var_813 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1142.numSelectables;
      }
