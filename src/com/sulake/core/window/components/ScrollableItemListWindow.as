package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1252:IItemListWindow;
      
      private var var_451:IScrollbarWindow;
      
      private var var_1942:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_88))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_451)
         {
            this.var_451.removeEventListener(WindowEvent.const_263,this.scrollBarEventProc);
            this.var_451.removeEventListener(WindowEvent.const_295,this.scrollBarEventProc);
            this.var_451 = null;
         }
         if(this.var_1252)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1252)
         {
            this.var_1252 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_451)
         {
            this.var_451 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_451)
            {
               this.var_451.addEventListener(WindowEvent.const_263,this.scrollBarEventProc);
               this.var_451.addEventListener(WindowEvent.const_295,this.scrollBarEventProc);
            }
         }
         return this.var_451;
      }
      ...
      {
         if(param1.type == WindowEvent.const_263)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_295)
         {
            this.hideScrollBar();
         }
      }
