package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1639:uint = 0;
      
      protected var var_314:Function;
      
      protected var var_1423:int;
      
      protected var var_1422:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         {
            this._window = param1;
            this._window.addEventListener(WindowEvent.const_338,this.clientWindowDestroyed);
            this.var_314 = param2;
            this._working = true;
            this.var_1423 = param4;
            this.var_1422 = param5;
            this.var_214 = new Timer(40,0);
            this.var_214.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_214.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1423 *= 0.75;
         this.var_1422 *= 0.75;
         if(Math.abs(this.var_1423) <= 1 && Math.abs(this.var_1422) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_314 != null)
         {
            this.var_314(this.var_1423,this.var_1422);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_214.stop();
            this.var_214.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_214 = null;
         }
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_338,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
