package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1757:uint = 0;
      
      public static const const_930:uint = 1;
      
      public static const const_1164:uint = 2;
      
      public static const const_775:uint = 4;
      
      public static const const_1786:uint = 8;
      
      public static const const_1738:uint = 16;
      
      public static const const_2135:uint = 64;
      
      public static const const_2267:uint = 128;
      
      public static const const_1204:uint = 256;
      
      protected static var var_612:uint = 0;
      
      protected static var var_364:uint = 0;
       
      
      protected var var_239:DisplayObjectContainer;
      
      protected var var_2259:Boolean;
      
      protected var var_935:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1164:
               ...
               break;
            case GraphicContext.const_1786:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1738:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_775:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1204:
               break;
            case GraphicContext.const_1757:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_239.numChildren > 0)
               {
                  this.var_239.removeChildAt(0);
               }
            }
            this.var_239 = null;
            while(numChildren > 0)
         ...
         if(this.var_935)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_364 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2259,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2259,16777215);
                  }
                  var_364 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_935)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_364 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_239 == null)
         {
            ...
            this.var_239.name = this.name + " - Child Container";
            this.var_239.mouseEnabled = false;
      ...
      {
         return this.var_239 != null ? int(this.var_239.numChildren) : 0;
      }
