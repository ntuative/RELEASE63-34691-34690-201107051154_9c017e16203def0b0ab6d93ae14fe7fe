package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_101:String = "default";
      
      public static const const_92:String = "active";
      
      public static const const_94:String = "focused";
      
      public static const const_87:String = "hovering";
      
      public static const const_56:String = "selected";
      
      public static const const_96:String = "pressed";
      
      public static const const_88:String = "disabled";
      
      public static const const_74:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_355 = SkinLayoutEntity.const_541;
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_353;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_601;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_368;
                  break;
               case "center":
                  _loc5_.var_355 = SkinLayoutEntity.const_620;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_541;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_353;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_601;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_368;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_620;
            }
         }
