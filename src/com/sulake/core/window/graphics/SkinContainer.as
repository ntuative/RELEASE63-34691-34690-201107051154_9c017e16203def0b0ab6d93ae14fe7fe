package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1467:String = "skin";
      
      private static const const_1471:String = "bitmap";
      
      private static const const_1468:String = "fill";
      
      private static const const_1466:String = "text";
      
      private static const const_1470:String = "label";
      
      private static const const_1469:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "TutorialMainView";
      
      protected static var var_363:Array;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_976 = new Dictionary();
         this.var_977 = new Dictionary();
         this.var_1854 = new Dictionary();
         this.var_2471 = new Dictionary();
         TypeCodeTable.method_2(this.var_1854,this.var_2471);
         this.var_2472 = new Dictionary();
         this.var_2473 = new Dictionary();
         StateCodeTable.method_2(this.var_2472,this.var_2473);
         this.var_445 = new Dictionary();
         this.var_445[const_1467] = BitmapSkinRenderer;
         this.var_445[const_1471] = BitmapDataRenderer;
         this.var_445[const_1468] = FillSkinRenderer;
         this.var_445[const_1466] = TextSkinRenderer;
         this.var_445[const_1470] = LabelRenderer;
         this.var_445[const_1469] = ShapeSkinRenderer;
         this.var_445[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_445[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_363 == null)
         {
            var_363 = new Array();
            var_363.push(WindowState.const_74);
            var_363.push(WindowState.const_88);
            var_363.push(WindowState.const_96);
            var_363.push(WindowState.const_56);
            var_363.push(WindowState.const_87);
            var_363.push(WindowState.const_94);
            var_363.push(WindowState.const_92);
            var_363.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3038 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1854[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_976[param1] == null)
         {
            this.var_976[param1] = new Array(const_1076);
         }
         this.var_976[param1][param2] = param3;
         if(this.var_977[param1] == null)
         {
            this.var_977[param1] = new Array(const_1076);
         }
         this.var_977[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_976[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_977[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_105)
