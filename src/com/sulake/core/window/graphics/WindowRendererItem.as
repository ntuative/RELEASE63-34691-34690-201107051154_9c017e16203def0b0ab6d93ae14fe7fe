package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1046:uint = 1;
      
      private static const const_1045:uint = 2;
       
      
      private var var_126:BitmapData;
      
      private var var_181:WindowRenderer;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1045) : uint(const_679);
         var _loc6_:Boolean = this.var_193.width > 0 && this.var_193.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_948))
            {
               _loc5_ = const_1046;
            }
         }
         ...
         if(_loc5_ != const_679)
         {
            this.var_1444 = this.var_948;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1046)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_623)
                  {
                     ...
                     _loc7_.draw(param1,this.var_126,this.var_126.rect,this.var_948,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1150.tx = param2.x;
                     this.var_1150.ty = param2.y;
                     this.var_909.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_126,this.var_1150,this.var_909,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1444;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1395:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_941:
               this.var_948 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_948 != this.var_1444)
               {
                  this.var_623 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1168:
               ...
               break;
            case WindowRedrawFlag.const_1332:
               _loc4_ = true;
         }
         if(_loc4_)
         {
