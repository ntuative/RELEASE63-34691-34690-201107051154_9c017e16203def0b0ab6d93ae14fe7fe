package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_750:Point;
      
      protected var var_190:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_181:IWindowRenderer;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_362 = new Array();
            var_362[0] = MouseCursorType.const_374;
            var_362[1] = MouseCursorType.const_31;
            var_362[2] = MouseCursorType.const_374;
            var_362[3] = MouseCursorType.const_374;
            var_362[4] = MouseCursorType.const_374;
            var_362[5] = MouseCursorType.const_31;
            var_362[6] = MouseCursorType.const_374;
         }
         if(var_317 == null)
         {
            var_317 = new Array();
            var_317[0] = WindowState.const_92;
            var_317[1] = WindowState.const_94;
            var_317[2] = WindowState.const_87;
            var_317[3] = WindowState.const_74;
            var_317[4] = WindowState.const_56;
            var_317[5] = WindowState.const_96;
            var_317[6] = WindowState.const_88;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_303;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1408 as WindowController;
         this.var_190 = state.var_1407 as WindowController;
         this.var_181 = state.renderer;
         this.var_931 = state.var_1410;
         eventQueue.begin();
         this.var_750.x = -1;
         this.var_750.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_750.x || event.stageY != this.var_750.y)
            {
               this.var_750.x = event.stageX;
               this.var_750.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_750,array,WindowParam.const_30);
            }
         ...
         state.var_1408 = this.var_71;
         state.var_1407 = this.var_190;
         state.renderer = this.var_181;
         state.var_1410 = this.var_931;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         {
            if(param1 != this.var_190)
            {
               if(this.var_190 && !this.var_190.disposed)
               {
                  this.var_190.update(this.var_190,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_190,param1));
                  this.var_190 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         var _loc5_:BitmapData = this.var_181.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_619))
         {
