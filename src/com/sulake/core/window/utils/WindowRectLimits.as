package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_330:int = -2.147483648E9;
      
      private var var_328:int = 2.147483647E9;
      ...
      {
         this.var_330 = param1;
         if(this.var_330 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_330)
         {
      ...
      {
         this.var_328 = param1;
         if(this.var_328 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_328)
         {
      ...
      {
         return this.var_329 == int.MIN_VALUE && this.var_331 == int.MAX_VALUE && this.var_330 == int.MIN_VALUE && this.var_328 == int.MAX_VALUE;
      }
      ...
      public function setEmpty() : void
      {
         ...
         this.var_330 = int.MIN_VALUE;
         this.var_328 = int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_330)
            {
               this._target.height = this.var_330;
            }
            else if(this._target.height > this.var_328)
            {
               this._target.height = this.var_328;
            }
         }
