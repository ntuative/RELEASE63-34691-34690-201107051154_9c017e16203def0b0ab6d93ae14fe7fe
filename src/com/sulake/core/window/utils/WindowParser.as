package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1167:String = "_EXCLUDE";
      
      public static const const_2173:String = "_INCLUDE";
      
      public static const const_2280:String = "_TEMP";
      
      private static const const_1620:String = "layout";
      
      private static const const_1142:String = "window";
      
      private static const const_1140:String = "variables";
      
      private static const const_1141:String = "filters";
      
      private static const const_711:String = "name";
      
      private static const const_1616:String = "style";
      
      private static const const_719:String = "params";
      
      private static const const_1623:String = "tags";
      ...
      private static const const_1618:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1168:String = "blend";
      
      private static const const_1615:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1613:String = "treshold";
      
      private static const const_1626:String = "children";
      
      private static const const_1617:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1619:String = "height_min";
      
      private static const const_1624:String = "height_max";
      
      private static const const_718:String = "true";
      
      private static const const_182:String = "0";
      
      private static const const_1622:String = "$";
      
      private static const const_1614:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1621:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1612:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1425:Dictionary;
      
      protected var var_1426:Dictionary;
      
      protected var var_1151:Dictionary;
      
      protected var var_1702:Dictionary;
      
      protected var var_2263:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1425 = new Dictionary();
         this.var_1426 = new Dictionary();
         TypeCodeTable.method_2(this.var_1425,this.var_1426);
         this.var_1151 = new Dictionary();
         this.var_1702 = new Dictionary();
         ParamCodeTable.method_2(this.var_1151,this.var_1702);
         this.var_2263 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1612,const_50);
         return param1.replace(const_1621,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1425)
            {
               delete this.var_1425[_loc1_];
            }
            for(_loc1_ in this.var_1426)
            {
               delete this.var_1426[_loc1_];
            }
            for(_loc1_ in this.var_1151)
            {
               delete this.var_1151[_loc1_];
            }
            for(_loc1_ in this.var_1702)
            {
               delete this.var_1702[_loc1_];
            }
            this.var_2263.dispose();
            this.var_2263 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1620)
         {
            _loc8_ = param1.child(const_1140);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1141).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1142);
         ...
         if(param1.localName() == const_1142)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1425[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_711,variables,"")));
         style = uint(this.parseAttribute(xml,const_1616,variables,style));
         params = uint(this.parseAttribute(xml,const_719,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1623,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_182));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_182));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_182));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_182));
         visible = this.parseAttribute(xml,const_1625,variables,visible.toString()) == const_718;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_719).length() > 0)
         {
            list = xml.child(const_719).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_711,variables,"") as String;
               if(this.var_1151[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_711)) + "\"!");
               }
               params |= this.var_1151[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1618,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1614);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1140)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1617,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1619,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1624,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_718;
         blend = Number(this.parseAttribute(xml,const_1168,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1615,variables,window.clipping.toString()) == const_718;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1613,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1141).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1426[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1167) == -1)
                  {
