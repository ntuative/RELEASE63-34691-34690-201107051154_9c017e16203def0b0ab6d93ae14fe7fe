package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_213:String = "regular";
      ...
      private static var var_533:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_685:String = "{";
      
      private static const const_684:String = "}";
      
      private static const const_1450:String = "/*";
      
      private static const const_1449:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_213],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_213] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_533.indexOf(_loc4_.name) == -1)
            {
               var_533.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_684);
         if(countSubStrings(param1,const_685) != countSubStrings(param1,const_684))
         {
            throw new Error("Mismatching amount of \"" + const_685 + "\" versus \"" + const_684 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1450) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1449) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_685)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
