package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1213:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1407:String = "_COLORIZE";
      
      protected static const const_1408:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1075:Point = new Point();
      ...
      protected var var_752:Function;
      
      protected var var_191:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_507 = _loc13_.var_3038;
            if(var_508 != _loc13_.background)
            {
      ...
      {
         return this.var_752 != null ? this.var_752 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_508 = param1;
         var_267 = !!var_508 ? uint(var_267 | var_604) : uint(var_267 & 16777215);
         this.var_191 = this.var_191 || param1;
         _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
      }
      
      public function set color(param1:uint) : void
      {
         var_604 = param1 & 4278190080;
         var_267 = !!var_508 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_604 = param1 << 24;
         var_267 = !!var_508 ? uint(var_604 | var_267) : uint(16777215 & var_267);
         _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_10,WindowRedrawFlag.const_1168);
      }
      ...
      {
         var_507 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_10,WindowRedrawFlag.const_941);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_92)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1408) == -1)
               {
                  _loc4_.style = var_92;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_375 = this._parent.rectangle.clone();
               var_68.x = var_10.x;
               var_68.y = var_10.y;
               var_68.width = var_10.width;
               var_68.height = var_10.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_651,this,this._parent);
            ...
            else
            {
               this.var_375.x = 0;
               this.var_375.y = 0;
               this.var_375.width = 0;
               this.var_375.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1853,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_930,var_10);
            this.var_21.visible = var_340;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_92,var_20,_context,var_10,null,this.var_752,this.properties,var_932.concat(),_id) as WindowController;
         _loc2_.var_507 = var_507;
         _loc2_.var_191 = this.var_191;
         _loc2_._debug = this._debug;
         _loc2_.var_375 = this.var_375.clone();
         ...
         _loc2_.var_604 = var_604;
         _loc2_.var_751 = var_751;
         _loc2_.var_340 = var_340;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2470 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_503)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_592)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_495)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1310,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_439,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_767))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1290;
                  if(testParamFlag(WindowParam.const_433))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_383))
                        {
               ...
               case WindowMouseEvent.const_25:
                  if(testStateFlag(WindowState.const_87))
                  {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_356:
                  return false;
            }
         }
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_644,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_214,WindowParam.const_197))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_205,WindowParam.const_185))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_492))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_627))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_158,this._parent,this);
               ...
               case WindowEvent.const_439:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1395);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1826,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_225,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_611:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1385,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_321,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_651:
                  if(testParamFlag(WindowParam.const_214,WindowParam.const_197))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_10,WindowRedrawFlag.const_61);
                  break;
               case WindowEvent.const_644:
                  this._parent.getRegionProperties(null,this.var_375);
                  this.updateScaleRelativeToParent();
                  break;
               ...
               case WindowEvent.const_458:
                  break;
               case WindowEvent.const_321:
                  this.activate();
                  break;
               case WindowEvent.const_158:
                  if(testParamFlag(WindowParam.WINDOW_PARAM_RESIZE_TO_ACCOMMODATE_CHILDREN))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_507);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_507);
      }
         ...
         if(this.var_191 && var_507 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_10.width && param1.y <= var_10.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1075,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1075,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_92 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1408) == -1)
               {
                  _loc6_.style = var_92;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_179,WindowParam.const_197);
         var _loc2_:* = !testParamFlag(WindowParam.const_144,WindowParam.const_185);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_10.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_375.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_434)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_443)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_375.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_361)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_248)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_540)
         {
            return true;
         }
         _state = WindowState.const_540;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1860,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_338,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1960,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_2035,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1886,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1944,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1972,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,false);
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1825,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1990,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_591,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         if(this.getStateFlag(WindowState.const_74))
         {
            return true;
         }
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1801,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1896,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1761,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_742,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_263,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_827,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_295,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_341,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1782,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1988,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1212 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1212 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_458,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
