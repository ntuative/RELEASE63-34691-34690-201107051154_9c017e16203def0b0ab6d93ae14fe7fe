package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_508:Boolean = false;
      
      protected var var_267:uint = 16777215;
      
      protected var var_604:uint;
      
      protected var var_507:uint = 10;
      
      protected var var_751:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_92 = param4;
         this.var_932 = param8 == null ? new Array() : param8;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_10 = null;
            this._context = null;
            this._state = WindowState.const_540;
            this.var_932 = null;
         }
      }
