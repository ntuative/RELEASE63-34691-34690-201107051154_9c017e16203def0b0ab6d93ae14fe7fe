package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_172:String = "WME_DOUBLE_CLICK";
      
      public static const const_44:String = "WME_DOWN";
      
      public static const const_2137:String = "WME_MIDDLE_CLICK";
      
      public static const const_2188:String = "WME_MIDDLE_DOWN";
      
      public static const const_2221:String = "WME_MIDDLE_UP";
      ...
      public static const const_303:String = "WME_UP_OUTSIDE";
      
      public static const const_356:String = "WME_WHEEL";
      
      public static const const_2262:String = "WME_RIGHT_CLICK";
      
      public static const const_2196:String = "WME_RIGHT_DOWN";
      
      public static const const_2182:String = "WME_RIGHT_UP";
      
      public static const const_1994:String = "WME_ROLL_OUT";
      
      public static const const_1986:String = "WME_ROLL_OVER";
      
      public static const const_2111:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_754 = param3;
         _loc13_.var_169 = false;
         _loc13_.var_755 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_513 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
