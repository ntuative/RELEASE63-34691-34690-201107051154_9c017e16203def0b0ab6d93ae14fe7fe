package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_945[param1];
         if(_loc4_ == null)
         {
            _loc4_ = new LocalizationDefinition(param1,param2,param3);
            this.var_945[param1] = _loc4_;
         }
      }
      
      public function activateLocalization(param1:String) : Boolean
      {
         var _loc2_:LocalizationDefinition = this.var_945[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_945[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2284);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_181));
         }
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_1780);
      }
      
      public function hasKey(param1:String) : Boolean
      {
         var _loc2_:Localization = this.var_77[param1] as Localization;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "") : String
      {
         var _loc3_:Localization = this.var_77[param1] as Localization;
         if(_loc3_ == null)
         {
            this.var_1164.push(param1);
            return param2;
         }
         return _loc3_.value;
      }
      ...
      {
         var _loc3_:Localization = this.var_77[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_77[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1730);
         }
      }
      ...
      {
         var _loc5_:Localization = this.var_77[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_77[param1] = _loc5_;
         }
      ...
      {
         return this.var_77[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_77)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1730);
            }
         }
      }
   }
