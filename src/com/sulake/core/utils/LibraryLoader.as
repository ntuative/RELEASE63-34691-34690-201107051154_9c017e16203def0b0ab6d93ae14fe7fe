package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2041:uint = 1;
      
      protected static const const_2040:uint = 2;
      
      protected static const const_2042:uint = 4;
      
      protected static const const_2043:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1991:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1246:Boolean = false;
      
      public static const const_1858:int = 2;
      
      private static var var_1014:Array = new Array();
      
      private static var var_822:Array = new Array();
      ...
      protected var var_268:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_695:Class;
      
      protected var var_512:uint = 0;
      
      protected var _name:String;
      
      protected var var_1146:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1147:Boolean = false;
      
      protected var var_3054:String = "";
      
      protected var var_3056:String = "";
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_44.load(param1.var_268,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1246)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_822[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_822.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_822.length < const_1858 && false)
            {
               _loc1_ = var_1014.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_822.push(_loc1_);
                  _loc1_.var_44.load(_loc1_.var_268,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_268 ? this.var_268.url : null;
      }
      ...
      {
         return !!this.var_1146 ? uint(this.var_1419 - this.var_2258) : uint(getTimer() - this.var_2258);
      }
      ...
      {
         this.var_268 = param1;
         this._name = parseNameFromUrl(this.var_268.url);
         this.var_1146 = false;
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1147 = false;
            if(!this.var_1146 && this.var_268)
            {
               this.var_1419 = -1;
               this.var_2258 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1146 && !_disposed && this.var_1420 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1991 - this.var_1420);
            if(this.var_3055)
            {
               this.var_268.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_268.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_3055 = false;
            }
            --this.var_1420;
            this.var_512 = 0;
            this.var_44.load(this.var_268,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_512 = LibraryLoader.name_5;
         ...
         if(this.var_512 == LibraryLoader.const_2043)
         {
         ...
         if(this.var_512 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_695 = this.getDefinition(this._name) as Class;
         if(this.var_695 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_268.url + "!");
            }
            return false;
         }
         ...
         try
         {
            xmlClass = this.var_695.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
