package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_692:Map = new Map();
      
      private static const const_389:Map = new Map();
      
      private static var var_1228:Boolean = false;
      ...
      {
         return const_692.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1228)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_692.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1228 = true;
         }
