package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1949:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1999:String = "bool";
      ...
      private static const const_724:String = "key";
      ...
      private static const const_2103:String = "ICaption";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_724);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_724));
         }
         else
         {
            _loc4_ = param1.child(const_724)[0];
         }
         ...
         else
         {
            ...
            else if(_loc5_ == const_314 || _loc5_ == const_156)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1949:
               return Number(param1);
            case const_37:
               return param1 == const_718 || int(param1) > 0;
            case const_1999:
               return param1 == const_718 || int(param1) > 0;
            case const_174:
               return uint(param1);
            case const_156:
               return param1.split(const_1614);
            default:
