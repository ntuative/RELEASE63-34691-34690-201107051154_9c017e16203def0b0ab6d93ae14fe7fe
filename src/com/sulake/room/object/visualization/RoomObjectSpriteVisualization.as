package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_402:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_219.length > 0)
            {
               _loc1_ = this.var_219[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_817.removeReference();
         }
         this.var_817 = param1;
         if(this.var_817 != null)
         {
            this.var_817.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_219.length > param1)
         {
            _loc2_ = this.var_219[this.var_219.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_219.length)
         {
