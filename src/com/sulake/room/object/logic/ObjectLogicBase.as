package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_402:IRoomObjectController;
      ...
      {
         if(this.var_402 == param1)
         {
            return;
         }
         if(this.var_402 != null)
         {
            this.var_402.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_402 = param1;
            this.var_402.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_402 != null)
            {
               this.var_402.setLocation(param1.loc);
               this.var_402.setDirection(param1.dir);
            }
         }
      }
