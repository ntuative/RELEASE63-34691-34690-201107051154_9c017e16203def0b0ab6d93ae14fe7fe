package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_810:int = -1;
      
      public static const const_1996:int = 0;
      ...
      private var var_3119:IRoomContentLoader;
      
      private var var_704:IRoomObjectFactory = null;
      
      private var var_571:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1316:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_408,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_581,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_906,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_704 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_704 == null || this.var_571 == null)
         {
            return;
         }
         this._state = const_1916;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_703.indexOf(_loc5_) < 0)
            {
               this.var_59.loadObjectContent(_loc5_,events);
               this.var_703.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1200;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_571.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_571.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_704.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_704 != null)
         {
            return this.var_704.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_810)
         {
            return;
         }
         if(this.var_59 == null)
         {
            this._state = const_810;
            return;
         }
         if(this.var_59.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_703.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_703.splice(_loc2_,1);
            }
            if(this.var_703.length == 0)
            {
               this._state = const_972;
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1069.length > 0)
         {
            _loc2_ = this.var_1069[0];
            this.var_1069.splice(0,1);
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2826)
            {
               this.var_2059 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_59 == null || this.var_571 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_571.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_571.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_704.createRoomObjectLogic(_loc6_);
