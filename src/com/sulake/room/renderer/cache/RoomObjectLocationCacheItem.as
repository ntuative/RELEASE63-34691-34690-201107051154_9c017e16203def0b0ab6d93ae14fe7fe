package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         this.var_1271 = new Vector3d();
         super();
         this._roomObjectVariableAccurateZ = param1;
         this.var_389 = new Vector3d();
      }
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1870 || param1.getUpdateID() != this.var_2724)
         {
            this.var_2724 = param1.getUpdateID();
            if(param2.updateId != this.var_1870 || _loc4_.x != this.var_1271.x || _loc4_.y != this.var_1271.y || _loc4_.z != this.var_1271.z)
            {
               this.var_1870 = param2.updateId;
               this.var_1271.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2725 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_389.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_389.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_389.x = Math.round(this.var_389.x);
            this.var_389.y = Math.round(this.var_389.y);
         }
         return this.var_389;
      }
   }
