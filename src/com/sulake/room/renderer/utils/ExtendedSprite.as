package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1523:int = 128;
      
      private var var_1524:Boolean = false;
      
      private var var_3075:Point;
      ...
      {
         if(param1 != this.var_1903 || param2 != this.var_1904)
         {
      ...
      {
         if(this.var_1523 > 255 || bitmapData == null)
         {
            return false;
         }
