package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_701:Point = new Point(0,0);
      
      private static const const_386:int = 50;
      
      private static const const_1425:int = 50;
      
      private static const const_1044:Number = 60;
      
      private static const const_1424:Number = 50;
      ...
      private var var_151:Sprite;
      
      private var var_111:Sprite;
      
      private var var_621:Map;
      
      private var var_520:Point;
      
      private var var_271:BitmapDataCache;
      
      private var var_622:RoomObjectCache;
      
      private var var_519:Array;
      
      private var var_619:Array;
      
      private var var_1442:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2292:Number = -1.0E7;
      ...
      private var var_617:Matrix;
      
      private var var_530:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_270.addChild(this.var_111);
         ...
         this.var_271 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_622 = new RoomObjectCache(_loc6_);
         this.var_909 = new ColorTransform();
         this.var_617 = new Matrix();
      ...
      {
         this.var_520.x -= param1 - this.var_618;
         this.var_618 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_520.y -= param1 - this.var_620;
         this.var_620 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1033 = true;
            if(this.var_151 != null && !this.var_270.contains(this.var_151))
            {
               this.var_270.addChild(this.var_151);
               this.var_111.mask = this.var_151;
            }
         }
         else if(!param1 && this.var_1033)
         {
            ...
            if(this.var_151 != null && this.var_270.contains(this.var_151))
            {
               this.var_270.removeChild(this.var_151);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_619.length)
            {
               this.cleanSprite(this.var_619[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_619 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_151 != null)
         {
            this.var_151.graphics.clear();
         }
         else
         {
            this.var_151 = new Sprite();
            this.var_151.name = "mask";
            if(this.var_1033)
            {
               this.var_270.addChild(this.var_151);
               this.var_111.mask = this.var_151;
         ...
         this.var_151.graphics.beginFill(0);
         this.var_151.graphics.drawRect(0,0,param1,param2);
         this.var_518 = param1;
         this.var_521 = param2;
      }
      ...
      {
         this.var_622.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1731 = !this.var_1731;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1441)
         {
            return;
         }
         ...
         if(this.var_518 != this.var_2288 || this.var_521 != this.var_2291)
         {
            _loc8_ = true;
         }
         if(this.var_111.x != this.var_618 || this.var_111.y != this.var_620)
         {
            this.var_111.x = this.var_618;
            this.var_111.y = this.var_620;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_519.sortOn("z",0 | 0);
         if(_loc5_ < this.var_519.length)
         {
            this.var_519.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_519[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2288 = this.var_518;
         this.var_2291 = this.var_521;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1441 > 0)
         {
            _loc2_ = param1 - this.var_1441;
            if(_loc2_ > const_1044 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2293 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_768;
               if(this.var_768 == const_386 + 1)
               {
                  this.var_530 = _loc2_;
                  this.var_1732 = this.var_2290;
               }
               else if(this.var_768 > const_386 + 1)
               {
                  _loc3_ = Number(this.var_768 - const_386);
                  this.var_530 = this.var_530 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1732 = this.var_1732 * (_loc3_ - 1) / _loc3_ + Number(this.var_2290) / _loc3_;
                  if(this.var_768 > const_386 + const_1425)
                  {
                     this.var_768 = const_386;
                     if(!this.var_1169 && this.var_530 > const_1044)
                     {
                        this.var_1169 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1169 && this.var_530 < const_1424)
                     {
                        this.var_1169 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_622.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_622.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1731 && this.var_1169);
         ...
         _loc13_ += int(this.var_518 / 2);
         _loc14_ += int(this.var_521 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_618;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_620;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_519.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_618;
                     _loc17_.y = _loc20_ - this.var_620;
      ...
      {
         if(param1 < this.var_518 && param1 + param3 >= 0 && (param2 < this.var_521 && param2 + param4 >= 0))
         {
            if(!this.var_3067)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_518)
         {
            param3 -= this.var_518 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_521)
         {
            param4 -= this.var_521 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2287)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_946)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_619.length > 0)
         {
            _loc3_ = this.var_619.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_946)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_769 || this.var_769 == 0)
         {
            _loc4_ = this.var_946 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_519.length)
         {
            return null;
         }
         return this.var_519[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_271.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_271.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_617.identity();
            if(flipH)
            {
               this.var_617.scale(-1,1);
               this.var_617.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_617.scale(1,-1);
               this.var_617.translate(0,data.height);
            }
            finalData.draw(data,this.var_617);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_701);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_909.redMultiplier = tR;
            this.var_909.greenMultiplier = tG;
            this.var_909.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_909);
            if(name.length > 0)
            {
               this.var_271.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_618;
         param2 -= this.var_620;
         this.var_520.x = param1;
         this.var_520.y = param2;
         if(this.var_1170 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1733;
         }
         this.var_1733 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1170;
         return this.var_1733;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_518 / 2;
         var _loc12_:Number = param2 - this.var_521 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1734,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2292 || param2 != this.var_2289)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_366.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1442.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1170 == 0)
         {
            this.checkMouseHits(this.var_520.x,this.var_520.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1170 = 0;
         ++this.var_1734;
      }
