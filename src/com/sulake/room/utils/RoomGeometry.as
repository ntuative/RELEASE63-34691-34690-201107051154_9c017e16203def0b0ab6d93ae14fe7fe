package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_545:Number = 64;
      
      public static const const_1348:Number = 32;
      ...
      private var var_179:Vector3d;
      
      private var var_1406:Vector3d;
      
      private var var_501:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1405:Vector3d;
      ...
      private var var_3097:Number = -500.0;
      
      private var var_3098:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1406 = new Vector3d();
         this.var_501 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1405 = new Vector3d();
         this.var_2202 = 1;
         this.var_2201 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2200 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      public function get location() : IVector3d
      {
         ...
         this.var_501.x *= this.var_499;
         this.var_501.y *= this.var_498;
         this.var_501.z *= this.var_500;
         return this.var_501;
      }
      ...
      {
         if(this.var_498 != param1 * this.var_2201)
         {
            this.var_498 = param1 * this.var_2201;
            ++this.var_189;
         }
      }
      ...
      {
         if(this.var_500 != param1 * this.var_2200)
         {
            this.var_500 = param1 * this.var_2200;
            ++this.var_189;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_107.y /= this.var_498;
         this.var_107.z /= this.var_500;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_497.x;
         var _loc3_:Number = this.var_497.y;
         var _loc4_:Number = this.var_497.z;
         this.var_497.assign(param1);
         this._direction.assign(param1);
         if(this.var_497.x != _loc2_ || this.var_497.y != _loc3_ || this.var_497.z != _loc4_)
         {
            ++this.var_189;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_178.assign(_loc24_);
            this.var_179.assign(_loc25_);
            this.var_1406.assign(this.var_179);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_178.assign(_loc19_);
            this.var_179.assign(_loc20_);
            this.var_1406.assign(this.var_179);
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_601 != null)
         {
            ...
            return this.var_601.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1405.assign(_loc22_);
         }
         else
         {
            this.var_1405.assign(_loc17_);
         }
         ++this.var_189;
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(this.var_179,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_178);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_179);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_498;
         _loc2_.z *= this.var_500;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1405);
         if(_loc3_ < this.var_3097 || _loc3_ > this.var_3098)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_178);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_498;
            _loc2_.z *= this.var_500;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1405);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_178,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_107.x * this.var_499,this.var_107.y * this.var_498,this.var_107.z * this.var_500);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_179;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_499,param2.y * this.var_498,param2.z * this.var_500);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_499,param3.y * this.var_498,param3.z * this.var_500);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_499,param4.y * this.var_498,param4.z * this.var_500);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1348;
         }
         else
         {
            this.scale = const_545;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_545;
      }
