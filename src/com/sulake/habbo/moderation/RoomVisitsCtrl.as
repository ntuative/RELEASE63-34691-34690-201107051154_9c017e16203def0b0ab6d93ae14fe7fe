package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_960:Array = [];
      
      private static var var_1789:int = 200;
      ...
      {
         this.var_778 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1938;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_960.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_778.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_960.length < var_1789)
         {
            ...
            param1.width = this.var_778.width;
            param1.height = this.var_778.height;
            var_960.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1460)
         {
