package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1134:Array = [];
      
      private static var var_2188:int = 1000;
      
      private static var var_1135:Array = [];
      
      private static var var_2189:int = 200;
      ...
      private var var_1879:IMessageComposer;
      ...
      {
         this.var_922 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_921 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_527 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1879);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1134.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_921.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1134.length < var_2188)
         {
            ...
            param1.width = this.var_921.width;
            param1.height = this.var_921.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1135.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_922.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1135.length < var_2189)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_922.width;
            param1.height = this.var_922.height;
            var_1135.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1687.getValue(param2.chatterName))
            {
               this.var_1687.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1687.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1686)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1685)
         {
