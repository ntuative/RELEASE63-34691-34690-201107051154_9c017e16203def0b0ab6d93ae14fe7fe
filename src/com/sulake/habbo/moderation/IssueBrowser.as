package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2363:String = "my_issues";
      
      private const const_2365:String = "open_issues";
      
      private const const_2364:String = "picked_issues";
      
      private const const_2382:String = "closed_issues";
      ...
      private var var_1941:IIssueBrowserView;
      
      private var var_1940:IIssueBrowserView;
      
      private var var_1939:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_284 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_284.numTabItems)
            {
               _loc5_ = this.var_284.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_284 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_284 == null || this.var_284.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_284.selector.getSelectableByName("open_issues");
         this.var_284.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_382 == _loc2_)
         {
            return;
         }
         if(this.var_382 != null)
         {
            this.var_382.visible = false;
         }
         this.var_382 = _loc2_;
         if(this.var_382 == null)
         {
         ...
         this.var_382.view.width = this.var_284.container.width;
         this.var_382.view.height = this.var_284.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2363:
               if(this.var_1941 == null)
               {
                  this.var_1941 = new MyIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1941;
            case this.const_2365:
               if(this.var_1940 == null)
               {
                  this.var_1940 = new OpenIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1940;
            case this.const_2364:
               if(this.var_1939 == null)
               {
                  this.var_1939 = new PickedIssuesView(this.issueManager,this,this.var_284.container);
               }
