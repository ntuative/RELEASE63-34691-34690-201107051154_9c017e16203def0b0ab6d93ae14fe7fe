package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1040:int = 60;
      
      private static const const_1041:int = 3600;
      
      private static const const_1042:int = 86400;
      
      private static const const_1043:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1040)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1041)
         {
            return Math.round(param1 / const_1040) + " mins ago";
         }
         if(param1 < 2 * const_1042)
         {
            return Math.round(param1 / const_1041) + " hours ago";
         }
         if(param1 < 2 * const_1043)
         {
            return Math.round(param1 / const_1042) + " days ago";
         }
         return Math.round(param1 / const_1043) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1161.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1161.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1312,this._data.userId),this._callerFrame,this.var_1162,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1162,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1468),this._callerFrame,this.var_1162,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1468),this._callerFrame,this.var_1162,false,true);
      }
