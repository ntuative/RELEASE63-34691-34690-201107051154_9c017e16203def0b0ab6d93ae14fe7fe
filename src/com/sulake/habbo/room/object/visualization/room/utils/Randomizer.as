package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2246:int = 1;
      
      public static const const_2238:int = 16777216;
      ...
      private var var_2087:int = 16777216;
      
      private var var_3088:int = 69069;
      
      private var var_3087:int = 5;
      ...
      {
         var _loc1_:int = this.var_3088 * this.var_2088 + this.var_3087;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2087;
         this.var_2088 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2087 * param2);
      }
   }
}
