package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_2023:int = 16777215;
      
      public static const const_1769:int = 13421772;
      
      private static const const_1081:int = 16777215;
      
      private static const const_1083:int = 13421772;
      
      private static const const_1080:int = 10066329;
      
      private static const const_1082:int = 10066329;
      
      public static const const_1843:int = 16777215;
      
      public static const const_1752:int = 13421772;
      
      public static const const_1953:int = 10066329;
      ...
      private var var_798:Rectangle = null;
      
      private var var_540:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1089:Number = NaN;
      
      private var var_1512:Number = NaN;
      
      private var var_2516:Number = NaN;
      
      private var var_1869:String = null;
      
      private var var_1227:uint = 16777215;
      
      private var var_2512:int = 255;
      
      private var var_2517:int = 255;
      ...
      private const const_2349:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_540 = new RoomPlaneBitmapMaskParser();
         this.var_332["null"] = false;
         this.var_332["null"] = true;
         this.var_332["null"] = true;
         this.var_332["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_798 = super.boundingRectangle;
         }
         return new Rectangle(this.var_798.x,this.var_798.y,this.var_798.width,this.var_798.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_79 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_79)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1089))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1089;
         }
         if(!isNaN(this.var_1512))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1512;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_842);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1329);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_453)
            {
               ...
               {
                  _loc13_.color = const_1752;
               }
               else
               {
                  _loc13_.color = const_1953;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1922)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_453)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2349 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_379.length)
            {
               _loc11_ = this.var_649[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_379[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1871)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2513 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2517 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2512 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1870)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1543 || _loc3_.y != this.var_2515 || _loc3_.z != this.var_2514 || param1.scale != this.var_1872))
            {
               this.var_1543 = _loc3_.x;
               this.var_2515 = _loc3_.y;
               this.var_2514 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1169);
            if(_loc3_ != this.var_1869)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1869 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_757));
            if(_loc4_ != this.var_1227)
            {
               this.var_1227 = _loc4_;
               this.var_2513 = this.var_1227 & 255;
               this.var_2517 = this.var_1227 >> 8 & 255;
               this.var_2512 = this.var_1227 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1212));
            if(_loc5_ != this.var_1871)
            {
               this.var_1871 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_221);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_233);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_230);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_976));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_932));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_931));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1366);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1378);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1089 || _loc3_ != this.var_1512))
            {
               this.var_1089 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1286);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2516)
            {
               this.var_2516 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_155.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_79 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_332["null"] || param2 != this.var_332["null"] || param3 != this.var_332["null"])
         {
            this.var_332["null"] = param1;
            this.var_332["null"] = param2;
            this.var_332["null"] = param3;
            this.var_379 = [];
            this.var_649 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_379;
         if(this.var_379.length == 0)
         {
            _loc6_ = this.var_155;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_379.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_332[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_379.push(_loc12_);
                        this.var_649.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1226;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_540.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_540.maskCount)
         {
            _loc10_ = this.var_540.getMaskType(_loc8_);
            _loc11_ = this.var_540.getMaskLocation(_loc8_);
            _loc12_ = this.var_540.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_155.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_79 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_79 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_302)
                              {
