package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1032:IPlaneRasterizer = null;
      
      private var var_873:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2745:Number = 0;
      
      private var var_2742:Number = 0;
      
      private var var_2744:Number = 0;
      
      private var var_2741:Number = 0;
      
      private var var_218:Map = null;
      
      private var var_462:PlaneBitmapData = null;
      ...
      private var var_843:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2745 = param9;
         this.var_2742 = param10;
         this.var_2744 = param11;
         this.var_2741 = param12;
         this.var_1033 = param6;
      }
      
      public function set canBeVisible(param1:Boolean) : void
      {
         if(param1 != this.var_843)
         {
            if(!this.var_843)
            {
      ...
      {
         return this._isVisible && this.var_843;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_218 != null)
         {
            ...
            {
               _loc2_ = this.var_218.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_701);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_218.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_218 != null)
         {
            ...
            {
               _loc3_ = this.var_218.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1032.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_462;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_218.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_843 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_392))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_336.length * param1.scale;
            _loc6_ = this.var_337.length * param1.scale;
            ...
            if(this.var_1032 != null)
            {
               _loc3_ = this.var_1032.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1983,this.var_2745,this.var_2742,this.var_2744,this.var_2741,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1870 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_843)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1250);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_177.z - originZ,this.var_133.z - originZ,this.var_101.z - originZ,this.var_132.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2660 = relativeDepth;
            this._isVisible = true;
            this.var_1870 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2743);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1033)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_289.length)
            {
               _loc4_ = this.var_289[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_289.length == this.var_1031.length)
         {
            while(_loc1_ < this.var_289.length)
            {
               _loc4_ = this.var_289[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1031.length)
                  {
                     _loc7_ = this.var_1031[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_393.length > this.var_1568.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1033 || this.var_289.length == 0 && this.var_393.length == 0 && !this.var_392 || this.var_873 == null)
         {
            return;
         }
         ...
         if(this.var_392)
         {
            ...
            while(_loc5_ < this.var_289.length)
            {
               _loc3_ = this.var_289[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc3_.leftSideLoc / this.var_336.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc3_.rightSideLoc / this.var_337.length;
                  _loc12_ = _loc3_.type;
                  this.var_873.updateMask(this.var_81,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1031.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_393.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_81.width - this.var_81.width * _loc4_.leftSideLoc / this.var_336.length;
                  _loc11_ = this.var_81.height - this.var_81.height * _loc4_.rightSideLoc / this.var_337.length;
                  _loc13_ = this.var_81.width * _loc4_.leftSideLength / this.var_336.length;
                  _loc14_ = this.var_81.height * _loc4_.rightSideLength / this.var_337.length;
                  this.var_81.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1568.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_392 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_253.copyChannel(param1,param1.rect,const_701,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_253.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_253,this.var_253.rect,const_701,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
