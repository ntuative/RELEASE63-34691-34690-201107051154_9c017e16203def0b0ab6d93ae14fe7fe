package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private const const_2369:int = 3;
      ...
      private const const_1533:int = 3;
      ...
      {
         this.var_739 = param1 as PetVisualizationData;
         createSprites(this.const_1533);
         var _loc2_:BitmapData = (this.var_739.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2172 = param1.getNumber(RoomObjectVariableEnum.const_258) > 0;
            this.var_1571 = param1.getString(RoomObjectVariableEnum.const_178);
            this.var_309 = param1.getString(RoomObjectVariableEnum.const_301);
            this.var_1681 = param1.getString(RoomObjectVariableEnum.const_894);
            this.var_1994 = param1.getNumber(RoomObjectVariableEnum.const_220);
            this.var_1525 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2577 = param1.getNumber(RoomObjectVariableEnum.const_447);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_208);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_511 != param1.getUpdateID() || this.var_1870 != param2.updateId)
         {
            ...
            if(_loc4_ != this.var_2176 || param3)
            {
               this.var_2176 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_43,_loc4_);
            }
            if(_loc5_ != this.var_2171 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_739.getAvatar(this._figure,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_740 = null;
         _loc2_ = getSprite(this.const_2093);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_1022 || this.var_1283 > 0 || this.var_1992;
         this.var_380.alpha = 0;
         if(this.var_1525 > 0)
         {
            _loc13_ = param2 - this.var_1525;
            if(_loc13_ < AvatarAction.const_1085)
            {
               ...
               this.var_1283 = this.const_2369;
            }
            else
            {
               this.var_1525 = 0;
            }
            _loc14_ = getSprite(this.const_2105);
            if(_loc14_ != null)
            {
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            if(_loc14_)
            {
               _loc19_ = this.var_67.getImage(AvatarSetType.const_43,false);
               if(_loc19_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1571 != null && this.var_1571 != "")
         {
            param1.appendAction(AvatarAction.const_348,this.var_1571);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1533;
