package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1493:String = "head";
      
      private static const const_695:int = 1;
      
      private static const const_1085:int = 1000;
      
      private static const const_1492:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1492) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_380 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2622)
            {
               this.var_2622 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_301);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_178);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_301);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_178);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2172 = _loc3_.getNumber(RoomObjectVariableEnum.const_258) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            if(!isNaN(_loc8_))
            {
               this.var_1908 = _loc8_;
            }
            else
            {
               this.var_1908 = direction;
            }
            this.var_1525 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2577 = _loc3_.getNumber(RoomObjectVariableEnum.const_447);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_966);
            if(_loc9_ != this.var_1907)
            {
               this.var_1907 = _loc9_;
               this.var_2623 = this.var_1907.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_380 != null)
         {
            ...
            if(this.var_1525 > 0)
            {
               _loc2_ = param1 - this.var_1525;
               if(_loc2_ < const_1085)
               {
                  this.var_380.alpha = int(Math.sin(_loc2_ / const_1085 * 0) * 255);
                  this.var_380.setExperience(this.var_2577);
               }
               else
               {
                  this.var_1525 = 0;
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_380.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_380.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_695;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2623);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_695)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_695))
            {
               if(param2 >= FurnitureVisualizationData.const_527.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_527[param2];
               if(_loc4_ == 1)
               {
                  return type + "_icon_" + _loc5_;
               }
               return type + "_" + _loc4_ + "_" + _loc5_ + "_" + this.getDirection(param1,param2) + "_" + this.method_4(_loc4_,param2);
            }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1908);
         }
         return direction;
      }
      ...
      {
         if(this.var_1000[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1493)
            {
               this.var_1000[param1] = true;
            }
            else
            {
               this.var_1000[param1] = false;
            }
         }
         return this.var_1000[param1];
      }
   }
}
