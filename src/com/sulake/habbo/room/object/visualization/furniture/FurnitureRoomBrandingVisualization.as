package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1662:String = "branded_image";
      
      private static const const_1664:int = 0;
      
      private static const const_1661:int = 1;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1703 = _loc4_.getNumber(RoomObjectVariableEnum.const_665);
                  this.var_1704 = _loc4_.getNumber(RoomObjectVariableEnum.const_595);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_518);
               }
            }
         }
         if(!this.var_1428)
         {
            this.var_1428 = this.checkIfImageReady();
            if(this.var_1428)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_334);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_580);
                     if(_loc4_ == 1)
                     {
