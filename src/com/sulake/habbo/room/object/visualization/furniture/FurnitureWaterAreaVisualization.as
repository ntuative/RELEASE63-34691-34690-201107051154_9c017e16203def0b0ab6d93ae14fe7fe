package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1448:String = "shore";
      ...
      {
         if(this.var_2423 == param1 && this.var_2422 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1448)
            {
               this.var_1821 = _loc2_;
               this.var_2423 = param1;
               this.var_2422 = direction;
               return this.var_1821;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1197.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_532 + 2;
         var _loc4_:int = this.var_638 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_637[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_637[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_532 == 0 || this.var_638 == 0)
         {
            ...
            this.var_532 = _loc2_.getNumber(RoomObjectVariableEnum.const_259);
            this.var_638 = _loc2_.getNumber(RoomObjectVariableEnum.const_364);
         }
         this.var_442 = [];
         this.var_637 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_532 * 2 + this.var_638 * 2)
         {
            this.var_442.push(false);
            this.var_637.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_532 + 2;
         var _loc2_:int = this.var_638 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_81 == null || this.var_81.width < param1 || this.var_81.height < param2)
         {
            if(this.var_81 != null)
            {
               this.var_81.dispose();
            }
            this.var_81 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_81,getSize(param3),this.var_442,this.var_637,assetCollection);
      }
