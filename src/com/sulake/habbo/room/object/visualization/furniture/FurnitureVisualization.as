package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2710:Number = NaN;
      
      private var var_2708:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1268:String = null;
      ...
      private var var_2712:Number = 0.0;
      ...
      private var var_1966:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_693 != spriteCount)
         {
            createSprites(this.var_693);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2608;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_412:
               break;
            case LayerData.const_1350:
               _loc2_ = "null";
               break;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_511 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2710)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2708 = _loc3_.getNumber(RoomObjectVariableEnum.const_273);
            ...
            this.var_1268 = this.getAdClickUrl(_loc3_);
            if(this.var_1268 == null || this.var_1268.indexOf("http") != 0)
            {
               this.var_1268 = null;
            }
            this.var_2608 = this.var_1268 != null;
            this.var_2713 = _loc3_.getNumber(RoomObjectVariableEnum.const_823);
      ...
      {
         if(this.var_2709 != param2 || this.var_2712 != param1)
         {
            this.var_1019 = [];
            this.var_1018 = [];
            this.var_831 = [];
            ...
            this.var_2711 = this.getSize(param1);
      ...
      {
         this.var_693 = param1;
         this.var_1558 = this.var_693 - this.getAdditionalSpriteCount();
      }
      ...
      protected function method_4(param1:int, param2:int) : int
      {
         return 0;
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_527.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1019[param2];
         var _loc4_:Boolean = this.var_1018[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2711;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1558)
            {
               _loc6_ = FurnitureVisualizationData.const_527[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1019[param2] = _loc3_;
            this.var_1018[param2] = _loc4_;
         }
         if(_loc4_)
         {
            _loc3_ += this.method_4(param1,param2);
         }
         return _loc3_;
      }
      ...
      {
         if(this.var_834[param3] != null && !this.var_1966)
         {
            return this.var_834[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_528;
         }
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2713 * (param1 / 2));
      }
