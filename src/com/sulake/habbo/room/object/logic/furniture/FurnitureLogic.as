package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private var var_1450:Number = 0.0;
      ...
      private var var_1177:RoomObjectUpdateMessage;
      
      private var var_952:Vector3d;
      
      private var var_307:Array;
      
      public function FurnitureLogic()
      {
         this.var_952 = new Vector3d();
         this.var_307 = [];
         super();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_336,RoomObjectRoomAdEvent.const_365,RoomObjectRoomAdEvent.const_519,RoomObjectStateChangeEvent.const_67,RoomObjectMouseEvent.const_168,RoomObjectRoomAdEvent.const_222,RoomObjectMouseEvent.const_497];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_1450 = Number(_loc3_);
         }
         this.var_2355 = this.var_532 / 2;
         this.var_2356 = this.var_638 / 2;
         ...
         while(_loc6_ < _loc4_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc7_,_loc5_))
            {
               ...
               this.var_307.push(_loc8_);
            }
            _loc6_++;
         }
         this.var_307.sort(Array.NUMERIC);
         if(object == null || object.getModelController() == null)
         {
            return;
         }
         object.getModelController().setNumber(RoomObjectVariableEnum.const_259,this.var_532,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_364,this.var_638,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_509,this.var_1450,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1906,this.var_2355,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1851,this.var_2356,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_952,this.var_1772,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_978,this.var_307,true);
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               if(eventDispatcher != null)
               {
                  _loc4_ = object.getId();
                  _loc5_ = object.getType();
                  _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_497,param1.eventId,_loc4_,_loc5_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
                  eventDispatcher.dispatchEvent(_loc6_);
               }
         }
      }
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.setString(RoomObjectVariableEnum.const_382,String(param1.extra));
            }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1362,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1773 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_369 = 1;
                  this.var_1177 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1773 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_369 > 0)
         {
            this.var_952.x = 0;
            this.var_952.y = 0;
            if(this.var_369 <= const_468 / 2)
            {
               this.var_952.z = const_1051 * this.var_369;
            }
            else if(this.var_369 <= const_468)
            {
               if(this.var_1177)
               {
                  super.processUpdateMessage(this.var_1177);
                  this.var_1177 = null;
               }
               this.var_952.z = const_1051 * (const_468 - this.var_369);
            }
            return this.var_952;
         }
         return null;
