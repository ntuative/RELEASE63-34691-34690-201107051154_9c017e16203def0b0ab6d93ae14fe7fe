package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_3003:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_2164 = _loc2_;
            this.var_3003 = param1.extra;
            this.var_1394 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1394 > 0 && param1 >= this.var_1394)
         {
            this.var_1394 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2164,String(this.var_2164),this.var_3003);
