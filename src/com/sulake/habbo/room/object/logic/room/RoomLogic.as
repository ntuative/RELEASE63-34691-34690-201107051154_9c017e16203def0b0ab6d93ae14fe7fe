package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1914:int = 255;
      
      private var var_1531:uint = 16777215;
      
      private var var_1916:int = 255;
      
      private var var_1242:uint = 16777215;
      
      private var var_1915:int = 255;
      
      private var var_1243:int = 0;
      
      private var var_1917:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_490,RoomObjectMouseEvent.const_168];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_842,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_757,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_976,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_932,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_931,1);
         }
      }
         ...
         if(this.var_1532)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_842,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1286,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1243)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1914;
            if(_loc2_ - this.var_1243 >= this.var_1917)
            {
               _loc3_ = this.var_1242;
               _loc4_ = this.var_1915;
               this.var_1243 = 0;
            }
            else
            {
               _loc7_ = this.var_1531 >> 16 & 255;
               _loc8_ = this.var_1531 >> 8 & 255;
               _loc9_ = this.var_1531 & 255;
               _loc10_ = this.var_1242 >> 16 & 255;
               _loc11_ = this.var_1242 >> 8 & 255;
               _loc12_ = this.var_1242 & 255;
               _loc13_ = (_loc2_ - this.var_1243) / this.var_1917;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1916 + (this.var_1915 - this.var_1916) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_757,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_1003:
               param2.setString(RoomObjectVariableEnum.const_233,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_845:
               param2.setString(RoomObjectVariableEnum.const_221,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_896:
               param2.setString(RoomObjectVariableEnum.const_230,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_630:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_302)
               {
                  _loc5_ = "null";
               }
               this.var_540.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_801:
               _loc4_ = this.var_540.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_540.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1169,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1376:
               param2.setNumber(RoomObjectVariableEnum.const_976,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1387:
               param2.setNumber(RoomObjectVariableEnum.const_932,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_931,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_720:
               param2.setNumber(RoomObjectVariableEnum.const_1366,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1309:
               param2.setNumber(RoomObjectVariableEnum.const_1378,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_150:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1532 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_161:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1212,int(param1.bgOnly));
         this.var_1531 = this._color;
         this.var_1916 = this.var_1914;
         this.var_1242 = _loc3_;
         this.var_1915 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_554,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_2010,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1743,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1958,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_554,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_292 || _loc12_ == RoomPlaneData.const_453)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
