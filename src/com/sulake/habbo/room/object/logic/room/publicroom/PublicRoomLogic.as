package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_222,RoomObjectRoomAdEvent.const_336,RoomObjectRoomAdEvent.const_365];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_456,"");
         _loc2_.setString(RoomObjectVariableEnum.const_934,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_560,Number(false));
         this.var_813 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1296:
                  _loc2_.setString(RoomObjectVariableEnum.const_456,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_934,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_560,Number(true));
                  this.var_1631 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1384);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_560,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_614)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_934);
