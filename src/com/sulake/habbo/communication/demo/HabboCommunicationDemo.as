package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_528:IKeyExchange;
      
      private var var_961:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2405:PseudoRandom;
      ...
      private const const_2064:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_633 = param1;
            this.var_64.initConnection(HabboConnectionType.const_245);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_64 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_64.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_64.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_64.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_64.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_64.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_64.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_64.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_64.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_64.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_64.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_64.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_64.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_64.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_64 && this.var_153 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_153.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_244 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_153.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_153.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_244.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_153.getKey("use.sso.ticket") == "1";
         this.var_633 = this.var_153.getKey("sso.ticket",null);
         this.var_1801 = this.var_153.getKey("flash.client.url","");
         this.var_2406 = this.var_153.getKey("external.variables.txt","");
         if(this.var_244 == null)
         {
            this.var_244 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_64.mode = HabboConnectionType.const_100;
            if(this.var_633)
            {
               this.var_64.initConnection(HabboConnectionType.const_245);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_749,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_2004);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_64.mode = HabboConnectionType.const_100;
            if(this.var_153.keyExists("local.environment"))
            {
               this.var_64.mode = HabboConnectionType.const_1185;
            }
         }
         this.var_64.initConnection(HabboConnectionType.const_245);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_64.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_875);
            _loc3_ = new InitCryptoMessageComposer(this.var_64.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2405 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_64.mode)
         {
            case HabboConnectionType.const_100:
               _loc6_ = "";
               _loc6_ = this.var_153.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_153.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1465 = _loc4_;
               this.var_244.loadBannerImage(_loc7_ + "?token=" + this.var_1465,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1185:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1976:
               this.var_961 = this.generateRandomHexString(30);
               this.var_528 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_528.init(this.var_961);
               _loc8_ = this.var_528.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_64.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_528.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_528.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2405);
         var _loc8_:ByteArray = CryptoTools.hexStringToByteArray(_loc5_);
         _loc8_.position = 0;
         _loc6_.init(_loc8_);
         _loc8_.position = 0;
         _loc7_.method_10(_loc6_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1464 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_291);
         connection.send(new VersionCheckMessageComposer(401,this.var_1801,this.var_2406));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2064,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_633 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_633);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_204);
         }
      ...
      {
         var _loc4_:IConnection = this.var_64.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_312);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1464)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_209);
         }
         if(param1.type == Event.CLOSE && !this.var_2404)
         {
            _loc2_ = this.var_153.getKey("logout.disconnect.url");
            _loc2_ = this.method_5(_loc2_);
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2404 = true;
         var _loc2_:String = this.var_153.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function method_5(param1:String) : String
      {
         if(param1.indexOf("%origin%") != -1)
         {
            return param1.replace("%origin%",this.var_153.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1465);
         ...
         var _loc9_:IConnection = this.var_64.getHabboMainConnection(null);
         ...
         this.var_528 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_528.init(_loc14_);
            _loc15_ = this.var_528.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_961 = _loc14_;
            }
