package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1010:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1358:Function;
      
      private var var_1360:Function;
      
      private var var_900:IAssetLibrary;
      
      private var var_1359:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_900 = param2;
         this._events = param3;
         this.var_1010 = param1.getDesktop(0);
         this.var_2955 = param4;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_900.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_900.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_612));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1360 != null)
            {
               this.var_1360(_loc4_);
               this.var_1360 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_900.loadAssetFromFile("hotel_view_banner_" + this.var_1359,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_920));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1010.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1010.removeChild(this._window);
         }
      }
   }
}
