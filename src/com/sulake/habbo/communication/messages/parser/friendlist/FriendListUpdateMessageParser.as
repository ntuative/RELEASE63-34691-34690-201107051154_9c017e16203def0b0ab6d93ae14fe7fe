package com.sulake.habbo.communication.messages.parser.friendlist
{
   ...
   public class FriendListUpdateMessageParser implements IMessageParser
   {
      ...
      public function flush() : Boolean
      {
         ...
         this.var_2049 = new Array();
         this.var_2048 = new Array();
         return true;
      }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_2050.push(new FriendCategoryData(param1));
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            {
               this.var_2048.push(new FriendData(param1));
            }
            else if(_loc5_ == 1)
            {
               this.var_2049.push(new FriendData(param1));
            }
            _loc3_++;
         }
         return true;
