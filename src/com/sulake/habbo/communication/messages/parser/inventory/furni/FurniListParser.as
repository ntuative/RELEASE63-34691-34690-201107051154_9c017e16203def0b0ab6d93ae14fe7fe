package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3051:int;
      
      protected var var_3050:int;
      
      protected var var_1697:Array;
      ...
      {
         this.var_3052 = param1.readString();
         this.var_3051 = param1.readInteger();
         this.var_3050 = param1.readInteger();
         this.var_1697 = new Array();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_1697.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
