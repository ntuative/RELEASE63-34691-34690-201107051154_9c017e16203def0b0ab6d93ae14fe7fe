package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1152:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1713:String = "sendAccessTokenToServer";
      
      private static const const_1712:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1713,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1712,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1152);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1152);
         }
      }
