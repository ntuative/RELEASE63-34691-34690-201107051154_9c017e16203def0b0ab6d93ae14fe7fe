package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1634:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1635:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_1145:Object = {"frontpage3":[7,8]};
      
      private static const const_1144:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         ...
         const_180["club_buy"] = ["club_link"];
         const_180["mad_money"] = ["ctlg_madmoney_button"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_888.length)
         {
            _loc2_ = String(this.var_888[param1]).replace("#","0x");
