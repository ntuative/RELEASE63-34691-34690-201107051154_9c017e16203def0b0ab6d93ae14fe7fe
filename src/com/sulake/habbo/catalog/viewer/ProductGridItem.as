package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1048:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_228:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_572:Object;
      ...
      {
         this._view.getChildByName(const_1048).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1048).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_87,MouseCursorType.const_738);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_738);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_228.select(this);
            this.var_572 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_572 != null && this.var_572 == param2)
         {
            _loc3_ = this.var_228.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_572 = null;
            }
