package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_457:IButtonWindow;
      ...
      {
         super(param1);
         this.var_457 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1354 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_457 != null)
         {
            this.var_457.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_457.disable();
         }
         this.var_1355 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1355 != null)
         {
            this.var_1355.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_457 != null)
         {
            this.var_457.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_217);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_136);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_217);
            this._soundManager.musicController.playSong(this.var_1100,HabboMusicPrioritiesEnum.const_217,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1100 = parseInt(_loc2_.extraParam);
            if(this.var_1355 != null)
            {
               this.var_1355.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1354.text = _loc8_;
            }
         }
         else if(this.var_1354 != null)
         {
            this.var_1354.text = "";
         }
         if(this.var_457 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1100);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1100);
         }
         return -1;
      }
