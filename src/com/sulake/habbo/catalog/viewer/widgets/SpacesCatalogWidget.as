package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1672:String = "default";
      ...
      private var var_1671:String = "1.1";
      
      private var var_1120:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1120 = this.parseElements(_loc2_.floors.pattern);
         this.var_1383 = this.parseElements(_loc2_.walls.pattern);
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1120)
                  {
                     _loc11_ = this.var_1120[_loc10_];
                     if(this.var_737.indexOf(_loc10_) == -1)
                     {
                        this.var_737.push(_loc10_);
                        this.var_1382.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1383[_loc8_] != null)
                  {
                     this.var_913.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1672,this.var_1671,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1381[this.var_492];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1672);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1382[this.var_494];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1671);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_737[this.var_494];
         var _loc3_:Array = this.var_1120[_loc2_];
         if(_loc3_ != null && this.var_493 >= 0)
         {
            _loc11_ = _loc3_[this.var_493];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1382[this.var_494];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_913[this.var_492];
         var _loc6_:Array = this.var_1383[_loc5_];
         if(_loc6_ != null && this.var_495 >= 0)
         {
            _loc13_ = _loc6_[this.var_495];
            if(_loc13_ != null)
            {
               this.var_1672 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1381[this.var_492];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_914[this.var_490];
         var _loc9_:Array = this.var_1380[_loc8_];
         if(_loc9_ != null && this.var_491 >= 0)
         {
            _loc15_ = _loc9_[this.var_491];
            if(_loc15_ != null)
            {
               this.var_1671 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_109:
               ...
               if(this.var_494 < 0)
               {
                  this.var_494 = this.var_737.length - 1;
               }
               if(this.var_494 >= this.var_737.length)
               {
                  this.var_494 = 0;
               }
               this.var_493 = 0;
               this.var_1118 = 0;
               _loc5_ = this.var_737[this.var_494];
               _loc6_ = this.var_1120[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1118 = _loc6_.length;
               }
            ...
            case const_244:
               ...
               if(this.var_492 < 0)
               {
                  this.var_492 = this.var_913.length - 1;
               }
               if(this.var_492 == this.var_913.length)
               {
                  this.var_492 = 0;
               }
               this.var_495 = 0;
               this.var_1117 = 0;
               _loc7_ = this.var_913[this.var_492];
               _loc8_ = this.var_1383[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1117 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_490 < 0)
               {
                  this.var_490 = this.var_914.length - 1;
               }
               if(this.var_490 >= this.var_914.length)
               {
                  this.var_490 = 0;
               }
               this.var_491 = 0;
               this.var_1119 = 0;
               _loc9_ = this.var_914[this.var_490];
               _loc10_ = this.var_1380[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1119 = _loc10_.length;
               }
