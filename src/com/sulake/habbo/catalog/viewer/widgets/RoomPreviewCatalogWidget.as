   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_572 != null && this.var_572 == param2)
         {
            if(this.var_104)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_104);
               this.var_572 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_2021 = _loc3_.id;
            this.var_2022 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_399 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_399,this._imageStoreWindow);
         }
      }
   }
}
