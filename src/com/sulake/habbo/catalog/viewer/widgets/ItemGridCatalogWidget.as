package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_214.stop();
            this.var_214.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_214 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_220)
         {
            this.var_214 = new Timer(25);
            this.var_214.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_214.start();
         }
         else
         {
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_646)
         {
            ++this.var_1857;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1857);
         }
      }
