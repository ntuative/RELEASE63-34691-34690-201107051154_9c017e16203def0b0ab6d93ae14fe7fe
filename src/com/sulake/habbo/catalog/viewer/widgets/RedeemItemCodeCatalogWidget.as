package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_985:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_985.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_985 = null;
         }
         if(this.var_986 != null)
         {
            this.var_986.removeEventListener(WindowKeyboardEvent.const_184,this.windowKeyEventProcessor);
            this.var_986 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_985 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_985 != null)
         {
            this.var_985.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_986 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_986 != null)
         {
            this.var_986.addEventListener(WindowKeyboardEvent.const_184,this.windowKeyEventProcessor);
         }
         return true;
      }
