package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1230:ITextWindow;
      
      private var var_99:IBitmapWrapperWindow;
      
      private var var_203:IWindowContainer;
      
      private var var_541:IDisplayObjectWrapper;
      
      private var var_1888:Point;
      
      private var var_542:IItemGridWindow;
      
      private var var_1516:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_203.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_203 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_998 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1230 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_99 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_203 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_203 != null)
         {
            this.var_203.visible = false;
            this.var_541 = this.var_203.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_541 != null && _loc3_ != null)
            {
               this.var_203.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_541.width,this.var_541.height);
               if(_loc4_ != null)
               {
                  this.var_541.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1888 = new Point(this.var_99.x,this.var_99.y);
         this.var_542 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1516 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_998.text = _loc4_;
         this.var_1230.text = _loc5_;
         this.var_998.height = this.var_998.textHeight + 5;
         this.var_1230.y = this.var_998.y + this.var_998.height;
         this.var_1230.height = Math.max(130,this.var_1230.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               ...
               case Offer.const_425:
                  ...
                  if(this.var_203 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_72 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_186)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_541 != null)
                        {
                     ...
                     case ProductTypeEnum.const_186:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_99.width,this.var_99.height,false,_loc15_);
                           _loc16_ = null;
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_348,AvatarAction.const_499);
                                 _loc18_.appendAction(AvatarAction.const_359,_loc9_.productClassId);
                                 _loc18_.endActionAppends();
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc16_ = _loc18_.getImage(AvatarSetType.const_43,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_99);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            if(this.var_99.bitmap == null)
            {
               this.var_99.bitmap = new BitmapData(this.var_99.width,this.var_99.height,true,16777215);
            }
            this.var_99.bitmap.fillRect(this.var_99.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_99.width - param1.width) / 2,(this.var_99.height - param1.height) / 2);
            this.var_99.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_99.invalidate();
            this.var_99.x = this.var_1888.x;
            this.var_99.y = this.var_1888.y;
            if(param3 != null)
            {
               this.var_99.x += param3.x;
               this.var_99.y += param3.y;
            }
         }
         if(param2)
         {
