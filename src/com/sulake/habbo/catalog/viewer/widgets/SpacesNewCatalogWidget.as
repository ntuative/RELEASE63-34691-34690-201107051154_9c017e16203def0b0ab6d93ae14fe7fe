package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_476:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_476 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_476)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_476.numSelectables)
            {
               _loc4_ = this.var_476.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_550]);
         this.method_6();
         return true;
      }
      ...
      {
         var _loc2_:int = this.var_639[this.var_550];
         var _loc3_:Offer = this.var_221[this.var_550][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_221[this.var_550][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_639[this.var_550] = (this.var_221[this.var_550] as Array).indexOf(_loc2_);
         this.method_6();
      }
      
      private function method_6() : void
      {
         var _loc1_:int = this.var_639[0];
         var _loc2_:int = this.var_639[1];
         var _loc3_:int = this.var_639[2];
         var _loc4_:Offer = this.var_221[0][_loc1_];
         var _loc5_:Offer = this.var_221[1][_loc2_];
         var _loc6_:Offer = this.var_221[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_403 || _loc1_.pricingModel == Offer.const_425))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_64 || _loc2_.productType == ProductTypeEnum.const_72))
            {
               continue;
            }
            ...
            while(this.var_221.length < this._groupNames.length)
            {
               this.var_221.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_221[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_221[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_476.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_476.setSelected(this.var_476.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_221[this.var_550],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_639[this.var_550];
