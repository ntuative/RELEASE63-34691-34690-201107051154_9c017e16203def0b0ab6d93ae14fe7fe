package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_483:Number = 0.25;
      
      private static const const_1638:int = 64;
      
      private static const const_1640:int = 32;
      
      private static const const_1639:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_199,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_1020,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_199,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_1020,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         ...
         this.var_350 = RoomObjectCategoryEnum.const_167;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_350 == RoomObjectCategoryEnum.const_27 && this.var_1346 == param1)
            {
               return const_66;
            }
            this.reset();
            this.var_1346 = param1;
            this.var_350 = RoomObjectCategoryEnum.const_27;
            this.var_1637 = "";
            if(this._roomEngine.addObjectFurniture(const_53,const_54,const_66,param1,new Vector3d(const_722,const_721,0),param2,0,""))
            {
               this.var_1350 = getTimer();
               this.var_1348 = true;
               return const_66;
            }
         }
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_350 == RoomObjectCategoryEnum.const_26 && this.var_1346 == param1 && this.var_1637 == param3)
            {
               return const_66;
            }
            this.reset();
            this.var_1346 = param1;
            this.var_350 = RoomObjectCategoryEnum.const_26;
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            this.reset();
            this.var_1346 = 1;
            this.var_350 = RoomObjectCategoryEnum.const_29;
            this.var_1637 = param1;
            if(this._roomEngine.addObjectUser(const_53,const_54,const_66,new Vector3d(const_722,const_721,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1350 = getTimer();
               this.var_1348 = true;
      ...
      public function changeRoomObjectState() : void
      {
         ...
         {
            this.var_1348 = false;
            if(this.var_350 != RoomObjectCategoryEnum.const_29)
            {
               this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_350);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1350 + const_1639)
            {
               this.var_1350 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_350);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_53,const_54,const_238,param1,param2,this.var_1347);
            this._roomEngine.setRoomCanvasMask(const_53,const_54,const_238,true);
            _loc4_ = this._roomEngine.getRoomCanvasGeometry(const_53,const_54,const_238);
            if(_loc4_ != null)
            {
               _loc4_.adjustLocation(new Vector3d(const_722,const_721,0),30);
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_53,const_54,const_66,this.var_350,const_238);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1349 >> 1),-(this.var_1093 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_50.width > this.var_1349 - this.var_50.width >> 1 || _loc3_.height - this.var_50.height > this.var_1093 - this.var_50.height >> 1 || this.var_50.width < 1 || this.var_50.height < 1)
               {
                  this.var_50 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         var _loc2_:IRoomGeometry = this._roomEngine.getRoomCanvasGeometry(const_53,const_54,const_238);
         if(this.var_50.width > this.var_1349 * (1 + const_483) || this.var_50.height > this.var_1093 * (1 + const_483))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1347 = const_1640;
               this.var_2113 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_50.left >>= 2;
         ...
         else if(this.var_50.width << 1 < this.var_1349 * (1 + const_483) - 5 && this.var_50.height << 1 < this.var_1093 * (1 + const_483) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2113)
            {
               _loc2_.performZoomIn();
               this.var_1347 = const_1638;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1093 - this.var_50.height >> 1;
         if(_loc4_ > 10)
         {
            _loc3_ += Math.min(15,_loc4_ - 10);
         }
         else if(this.var_350 != RoomObjectCategoryEnum.const_29)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.getRoomCanvasScreenOffset(const_53,const_54,const_238);
            if(_loc1_ != null)
            {
               this.updatePreviewObjectBoundingRectangle(_loc1_);
               if(this.var_50 != null)
               {
                  _loc2_ = this.var_1347;
                  _loc1_ = this.validatePreviewSize(_loc1_);
                  _loc3_ = this.getCanvasOffset(_loc1_);
                  if(_loc3_ != null)
                  {
                     this._roomEngine.setRoomCanvasScreenOffset(const_53,const_54,const_238,_loc3_);
                  }
                  if(this.var_1347 != _loc2_)
                  {
                     this.var_50 = null;
                  }
               }
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_53 && param1.roomCategory == const_54 && param1.objectId == const_66 && param1.category == this.var_350)
         {
            this.var_50 = null;
            this.var_2113 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_509);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_952);
