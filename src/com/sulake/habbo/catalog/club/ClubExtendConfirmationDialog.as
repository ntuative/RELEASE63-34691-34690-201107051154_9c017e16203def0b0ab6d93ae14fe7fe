package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1657:String = "your_price_icon";
      
      private static const const_1656:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1660:String = "image/png";
      
      private static const const_1659:int = 2000;
      
      private static const const_1658:int = 75;
      ...
      private var var_719:IRegionWindow;
      
      private var var_720:ITextWindow;
      
      private var var_416:IBitmapWrapperWindow;
      
      private var var_721:Vector.<BitmapData>;
      
      private var var_894:Timer;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_104 = param2;
         this.var_721 = new Vector.<BitmapData>(const_393);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_719)
         {
            this.var_719.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_719.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_719 = null;
         }
         if(this.var_720)
         {
         ...
         if(this.var_721)
         {
            ...
            {
               this.var_721[_loc1_].dispose();
               this.var_721[_loc1_] = null;
               _loc1_++;
            }
            this.var_721 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_719 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_720 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_719 || !this.var_720)
         {
            return;
         }
         this.var_719.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_719.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1656,const_1660,this.onTeaserLoaded);
         ...
         this.var_416 = this._view.findChildByName(const_1657) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_393)
         {
            ...
            this.var_721[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_720)
         {
            this.var_720.textColor = const_2050;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_720)
         {
            this.var_720.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_894 = new Timer(const_1659);
         this.var_894.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_894.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_416.bitmap)
         {
            this.var_416.bitmap.dispose();
         }
         if(this.var_722 < const_393)
         {
            this.var_416.bitmap = new BitmapData(this.var_416.width,this.var_416.height,true,0);
            this.var_416.bitmap.copyPixels(this.var_721[this.var_722],this.var_721[this.var_722].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_722);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_485 = new Timer(const_1658,const_393 - 1);
         this.var_485.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_485.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_485.start();
      }
