package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_661 != const_1091;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1925 != RecyclerStatusMessageEvent.const_1368;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_661 == const_474;
      }
      ...
      {
         this.var_661 = const_1092;
         this.var_131 = new Array(const_232);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_232)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_661 = const_1091;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1925)
         {
            case RecyclerStatusMessageEvent.const_1946:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1368:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1901:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1403:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1898:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_131[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_232)
            {
               oldObjectData = this.var_131[newSlotId];
         ...
         this.var_131[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_131[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_131[param1].id))
         {
            return;
         }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_131.length)
         {
            _loc3_ = this.var_131[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_131.length < const_232)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_131.length)
         {
            if(this.var_131[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
