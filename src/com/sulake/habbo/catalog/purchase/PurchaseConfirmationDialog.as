package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2091:uint = 4.293848814E9;
      
      private const const_2090:uint = 4.294967295E9;
      
      private const const_1430:uint = 4.291613146E9;
      ...
      public function showOffer(param1:IHabboCatalog, param2:IRoomEngine, param3:IPurchasableOffer, param4:int, param5:String = "", param6:Array = null) : void
      {
         ...
         this.var_1329 = param3.offerId;
         this.var_1625 = param4;
         this.var_1624 = param5;
         this.var_260 = param6;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1329 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_116,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_44,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_370,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_341,this.onMessageInputFocus);
         }
         this.var_2077 = true;
         this.var_2078 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_342,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_603,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1859 = _loc1_.stuffTypes;
            this.var_879 = _loc1_.boxTypes;
            this.var_877 = _loc1_.ribbonTypes;
            this.var_1328 = this.var_1859[0];
            this.var_406 = this.var_879[0];
            this.var_408 = this.var_877[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_408 < 0)
         {
            this.var_408 = this.var_877.length - 1;
         }
         if(this.var_408 > this.var_877.length - 1)
         {
            this.var_408 = 0;
         }
         if(this.var_406 < 0)
         {
            this.var_406 = this.var_879.length - 1;
         }
         if(this.var_406 > this.var_879.length - 1)
         {
            this.var_406 = 0;
         }
         var _loc1_:int = this.var_879[this.var_406] * 1000 + this.var_877[this.var_408];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1328,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1623 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1859)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_72);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1328);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_879[this.var_406]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_877[this.var_408]);
         this._catalog.purchaseProductAsGift(this.var_1625,this.var_1329,this.var_1624,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1625,this.var_1329,this.var_1624);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2880 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_260)
         {
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_407 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_407 + 1);
               break;
      ...
      {
         if(this.var_297 == null || !this.var_297.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_297.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_407) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_297 == null)
         {
            this.var_297 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_878 == null)
         {
            this.var_878 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_297 == null || this.var_878 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_297.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_878.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_297.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_407) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_407);
         }
         this.var_407 = param1;
         if(this.var_407 < 0)
         {
            this.var_407 = _loc2_.numListItems - 1;
         }
         if(this.var_407 >= _loc2_.numListItems)
         {
            this.var_407 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_407) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1430;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2091) : uint(this.const_2090);
      }
      ...
      {
         this.var_1328 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1328;
               }
            }
            _loc4_++;
         }
