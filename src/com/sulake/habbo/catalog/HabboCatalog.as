package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_707:uint = 1;
      ...
      private var var_1277:IRoomSession;
      ...
      private var var_223:CatalogViewer;
      ...
      private var var_160:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var _confirmationDialog:PurchaseConfirmationDialog;
      
      private var var_224:ChargeConfirmationDialog;
      ...
      private var var_2764:GiftWrappingConfiguration;
      
      private var var_1287:ClubGiftController;
      
      private var var_562:ClubBuyController;
      
      private var var_685:ClubExtendController;
      
      private var var_854:Map;
      
      private var var_1288:Boolean = false;
      
      private var var_852:IPurchasableOffer;
      ...
      private var var_684:RoomPreviewer;
      
      private const const_2086:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1108)
         {
            this.var_1108.release(new IIDAvatarRenderManager());
            this.var_1108 = null;
         }
         if(this.var_138)
         {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_76,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1989);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_396.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_562.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2762 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_396.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_149,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_138 != null && this.var_138.getKey("catalog.furniture.animation","ICaption") == "true")
         {
            if(this.var_684 == null)
            {
               this.var_684 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_138.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_813 || !this.var_255 || !this.var_255.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1039 = -1;
            this.var_853 = param1;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_138.getKey("client.credits.embed.enabled","ICaption") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_138.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_396.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_396.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_396.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_854.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         this.setupInventoryForRecycler(this.var_105.active && this.method_3());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_223.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_223 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_223.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_138.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_707) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2086;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_297,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_76:
               this.var_1999 = param1.session.isPrivateRoom;
               this.var_1277 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_160 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1287 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_562 == null)
         {
            this.var_562 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_685 == null)
         {
            this.var_685 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_223 != null)
         {
            this.var_223.catalogWindowClosed();
         }
         if(this.var_105 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_105.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1578 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_255.buildCatalogIndex(_loc2_);
         if(this.var_853 && this.var_853 != "")
         {
            this.var_255.openPage(this.var_853);
            this.var_853 = "";
            this.var_1039 = -1;
         }
         else if(this.var_1039 > -1)
         {
            this.var_255.openPageById(this.var_1039,this.var_1998);
            this.var_1039 = -1;
            this.var_1998 = -1;
            this.var_853 = "";
         }
         else if(this.var_1578 && this.var_2762)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_255.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1907));
         }
         else
         {
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_223.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_223 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_223.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2761 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1201);
         }
         this.var_2761 = false;
         if(this.var_224 != null && !this.var_224.disposed)
         {
            this.var_224.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_123,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2763 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1282);
         }
         this.var_2763 = false;
         if(this.var_224 != null && !this.var_224.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_344,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_748)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_371,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_344,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_371,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1241 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1287.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_160 != null)
         {
            this.var_160.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_160 != null)
         {
            this.var_160.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_160 != null)
         {
            this.var_160.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2764 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_160.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_562 != null)
         {
            this.var_562.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_685 != null && this.var_138.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_685.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_224 == null || this.var_224.disposed)
         {
            this.var_224 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_224.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_854.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_854.add(_loc2_.productCode,_loc3_.slice());
            this.var_223.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_138.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_138.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_142)
         {
            _loc3_ = this.var_138.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_138.keyExists("catalog.drag_and_drop") || this.var_138.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1277 || !this.var_1277.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1288 && param1.type == RoomEngineObjectEvent.const_149)
         {
            this.resetPlacedOfferData(true);
            if(this.var_852 == null || this.var_852.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_852.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_852);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_337,0.5);
            }
         }
      }
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_367:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
                     if(this.var_65.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_327:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_138.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_707);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_684 != null)
         {
            this.var_684.updatePreviewRoomView();
         }
      }
   }
}
