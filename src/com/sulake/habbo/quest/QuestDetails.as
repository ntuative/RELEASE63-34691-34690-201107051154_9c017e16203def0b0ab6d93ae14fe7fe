package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1458:int = 56;
      
      private static const const_473:int = 5;
      
      private static const const_1460:int = 5;
      
      private static const const_1069:Point = new Point(8,8);
      
      private static const const_1459:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         {
            this._window = IFrameWindow(this.var_48.getXmlWindow("QuestDetails"));
            this._window.findChildByTag("close").procedure = this.onDetailsWindowClose;
            this._window.center();
            _loc8_ = this.var_48.questController.questsList.createListEntry();
            _loc8_.x = const_1069.x;
            _loc8_.y = const_1069.y;
         ...
         this.var_48.questController.questsList.refreshEntryDetails(_loc8_,param1);
         ...
         if(!_loc2_)
         {
            _loc3_.caption = this.var_48.getQuestHint(param1);
            _loc3_.height = _loc3_.textHeight + const_1460;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_473);
         var _loc7_:IWindowContainer = IWindowContainer(_loc8_.findChildByName("quest_container"));
         _loc7_.height += _loc5_ + _loc6_;
         this.var_48.questController.questsList.setEntryHeight(_loc8_);
         this._window.height = _loc8_.height + const_1458;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_473 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_473 - _loc6_.height;
      ...
      {
         return this.var_142.waitPeriodSeconds < 1 && const_1459.indexOf(this.var_142.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_48.localization.hasKey(this.var_142.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_48.localization.hasKey(this.var_142.getCampaignLocalizationKey() + ".searchtag");
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_48.openNavigator(this.var_142);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Boolean = this.var_48.questController.questsList.refreshDelay(this._window,this.var_142);
         if(_loc2_)
         {
