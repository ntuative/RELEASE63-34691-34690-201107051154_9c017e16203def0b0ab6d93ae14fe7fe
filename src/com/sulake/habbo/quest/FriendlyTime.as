package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1159:int = 3600;
      
      private static const const_1725:int = 3 * const_1158;
      
      private static const const_1726:int = 3 * const_1159;
      ...
      {
         if(param2 > const_1726)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1159));
         }
         if(param2 > const_1725)
         {
