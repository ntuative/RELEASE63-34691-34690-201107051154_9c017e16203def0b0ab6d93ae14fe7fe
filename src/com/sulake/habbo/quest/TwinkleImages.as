package com.sulake.habbo.quest
{
   ...
   public class TwinkleImages implements IDisposable
   {
      ...
      private static const const_1478:int = 6;
      ...
      {
         PendingImage.retrievePreviewAsset(this.var_48,"ach_twinkle" + param1,this.onImageReady);
      }
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!_loc3_ || !this.var_48.assets)
         {
            return;
         }
         var _loc4_:BitmapDataAsset = this.var_48.assets.getAssetByName(_loc3_) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            return;
         }
