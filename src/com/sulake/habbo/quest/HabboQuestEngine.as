package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1473:int = 5;
      
      private static const const_1472:int = 800;
      
      private static const const_1475:int = 15;
      
      private static const const_1474:int = 300;
      ...
      private var var_1215:QuestController;
      
      private var var_979:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1215 = new QuestController(this);
         this.var_979 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1473);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_224,this.var_979.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_224,this.var_979.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1215.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_979.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1215.questTracker.isVisible();
      }
