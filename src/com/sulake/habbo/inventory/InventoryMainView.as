package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_486:int = 3;
      ...
      private var var_1944:IWindowContainer;
      ...
      private var var_1943:IWindowContainer;
      
      private const const_2086:Point = new Point(120,150);
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_92)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_818);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_383 != null && this.var_383 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_383 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_818);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_75:
               this.var_27.furniModel.resetUnseenItems();
               break;
            case InventoryCategory.const_121:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_383);
         }
         ...
         _loc2_.container.removeChild(this.var_1944);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_383 == InventoryCategory.const_121)
            {
               this.toggleCategoryView(InventoryCategory.const_121);
            }
            else if(this.var_383 == InventoryCategory.const_75)
            {
               this.toggleCategoryView(InventoryCategory.const_75);
            }
            else if(this.var_27 != null)
            {
               this.var_27.toggleInventoryPage(InventoryCategory.const_75);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1943)
         {
            this.var_1943 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1943,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_486;
            _loc3_.y = const_486;
         }
         return _loc3_;
      }
