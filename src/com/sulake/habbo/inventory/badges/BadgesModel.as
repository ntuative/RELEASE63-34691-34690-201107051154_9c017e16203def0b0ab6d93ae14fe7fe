package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2340:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_396 = param5;
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_224,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_614 = [];
         this.var_1159 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_224,this.onBadgeImageReady);
            this.var_396 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1159.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_614.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_396.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_240.unshift(_loc11_);
            }
            else
            {
               this.var_240.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_322);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_240.length)
         {
            _loc3_ = this.var_240[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_562);
         ...
         var _loc3_:Array = this.getBadges(const_322);
      ...
      {
         return this.getItemInIndex(param1,const_322);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_562);
      }
      ...
      {
         if(param1 == InventoryCategory.const_235 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_614.indexOf(_loc2_) == -1)
            {
               this.var_614.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_614 && this.var_614.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1365));
            this.var_614 = [];
            for each(_loc2_ in this.var_240)
            {
