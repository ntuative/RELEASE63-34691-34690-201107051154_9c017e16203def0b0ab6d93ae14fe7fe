package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_933:int = 0;
      
      protected var var_753:BitmapData;
      
      protected var var_2573:int;
      
      protected var var_1700:Boolean;
      
      protected var var_2255:Boolean;
      
      protected var var_3046:BitmapData;
      
      private var var_1535:Boolean;
      
      private const const_2077:Number = 1;
      
      private const const_2078:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2256 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1605));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_928)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2078;
               _loc1_.blend = this.const_2078;
            }
            else
            {
               this._window.blend = this.const_2077;
               _loc1_.blend = this.const_2077;
            }
         }
         this.var_1462.color = !!this.var_1535 ? uint(const_1485) : uint(const_1486);
         this.var_2587.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2255 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3046;
               _loc5_.visible = true;
            }
            else
            {
