package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1812:uint = 9;
      
      public static const const_236:uint = 0;
      
      public static const const_207:uint = 1;
      
      public static const const_404:uint = 2;
      
      public static const const_335:uint = 3;
      
      public static const const_625:uint = 4;
      
      public static const const_270:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1076 = new Map();
         this.var_1322 = false;
         this.var_2108 = param6;
         this.var_864 = true;
         this.state = const_207;
         this.var_60.setup(param1,param3,param4,param6);
         this.var_60.updateItemList(this.var_871);
         this.var_60.updateItemList(this.var_1616);
      ...
      public function close() : void
      {
         if(this.var_864)
         {
            if(this._state != const_236 && this._state != const_270)
            {
      ...
      {
         this.var_60.setMinimized(param1 != InventoryCategory.const_75);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_872 + " OTHER: " + this.var_1322);
         ...
         {
            case const_236:
               if(param1 == const_207 || param1 == const_270)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_295 == null || this.var_295.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_295.length)
         {
            _loc2_ = this.var_295.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1344);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_871)
            {
               this.var_872 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1322 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_60.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_871)
            {
               this.var_60.alertPopup(TradingView.const_1276);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_295.length < const_1812)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_206)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_295.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
