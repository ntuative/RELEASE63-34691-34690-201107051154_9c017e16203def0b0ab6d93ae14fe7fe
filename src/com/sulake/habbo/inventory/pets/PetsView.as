package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2065:int = 0;
      
      private const const_1056:int = 1;
      
      private const const_1055:int = 2;
      
      private const const_1053:int = 3;
      ...
      private var var_228:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_228 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_561.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_228.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_561 == null || this.var_561.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_561.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_561.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_228.addGridItem(_loc2_.window);
            this.var_561.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_228.removeGridItems();
         for each(_loc1_ in this.var_561)
         {
            _loc1_.dispose();
         }
         this.var_561.reset();
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_78.switchToFurnitureCategory(FurniModelCategory.const_36);
                  break;
               case "tab_wall":
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1056;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1055;
         }
         else
         {
         ...
         switch(_loc2_)
         {
            case this.const_1056:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1055:
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_432) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_430) > 0;
