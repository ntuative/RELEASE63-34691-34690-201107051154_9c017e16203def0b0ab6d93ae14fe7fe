      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1653.setSelectedGridItem(this);
               this.var_1654 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1654 = false;
                  this.var_1653.placePetToRoom(this._petData.id,true);
               }
         }
      }
