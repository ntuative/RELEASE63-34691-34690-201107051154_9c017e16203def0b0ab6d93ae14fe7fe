package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_622:int = 70;
      
      public static const const_1770:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_561:int = 1;
      
      private static const const_1119:int = 2;
      
      private static const const_1120:int = 3;
       
      
      private var _window:IWindow;
      
      private var var_246:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2056 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2056 = 15;
         }
         this.var_2054 = this._window.height;
         this.var_1611 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_246.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_561:
               ...
               _loc2_ = Number(this.var_1314) / Number(this.var_1068["time_fade_in"]);
               if(this.var_1314 > int(this.var_1068["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1119:
               ...
               if(this.var_1610 > int(this.var_1068["time_display"]) && !this.var_2055)
               {
                  this.startFadeOut();
               }
               break;
            case const_1120:
               ...
               _loc3_ = 1 - Number(this.var_1315) / Number(this.var_1068["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1315 > int(this.var_1068["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2056;
         if(this._window.height < this.var_2054)
         {
            this._window.height = this.var_2054;
         }
      }
      ...
      {
         this.var_1315 = 0;
         this._state = const_1120;
      }
      
      private function startDisplay() : void
      {
         this.var_1610 = 0;
         this._state = const_1119;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1770;
         this._window.y = this.var_1611;
      }
