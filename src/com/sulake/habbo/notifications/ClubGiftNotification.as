package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_702:String = "club_gift_notification";
      ...
      private var var_1954:ITextWindow;
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_702,this._window);
         this.var_1954 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_702);
         }
         if(this._window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "open_catalog_button":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1728,true);
               }
               this.dispose();
               break;
      ...
      {
         this.var_1954.textColor = const_1518;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_1954.textColor = const_1520;
      }
