package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1497:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1496:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_545:HabboAvatarEditorManager;
      
      private var var_1002:IFigureData;
      ...
      private var var_1240:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_545 = param2;
         this.var_1002 = this.var_545.avatarRenderManager.getFigureData(AvatarType.const_129);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_658["null"] = new FigureData(this);
         this.var_658["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_658["null"];
         var _loc3_:FigureData = this.var_658["null"];
         _loc2_.loadAvatarData(const_1497,FigureData.const_90);
         _loc3_.loadAvatarData(const_1496,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_544 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_954,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_57,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_253,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_946,new LegsModel(this));
         ...
         this.var_544.add(AvatarEditorSideCategory.const_118,new WardrobeModel(this));
         this.var_544.add(AvatarEditorSideCategory.const_582,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_805 != param3)
         {
            this.var_805 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_658[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1002.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1002.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_954);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_544.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_658[this.var_1034];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1240.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_545.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1910;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_805 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_696)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1695.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_545.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_545.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_545.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1409.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1933)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_805 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1409.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_545.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function method_11(param1:String) : int
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_805 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_544.getValue(AvatarEditorSideCategory.const_118);
      }
