package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2397 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1188 = new Dictionary();
         this.var_1799 = new Array();
         ...
         {
            this.var_1799.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1799.concat();
         for each(_loc3_ in this.var_1188)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2398 = _loc6_;
      }
