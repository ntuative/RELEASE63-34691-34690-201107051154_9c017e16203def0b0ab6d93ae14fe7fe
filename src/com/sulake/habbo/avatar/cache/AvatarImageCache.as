package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2063:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1481:IAvatarImage;
      ...
      private var var_496:AvatarImageBodyPartContainer;
      
      private var var_1453:String;
      
      private var var_127:AvatarImagePartContainer;
      
      private var var_2375:Point;
      ...
      private var var_2374:ByteArray;
      
      private var var_2376:ImageData;
      
      private var var_987:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_274.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_274.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_274.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_274.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_274.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_274.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_774 == GeometryType.const_1233 && param1 == GeometryType.const_1279 || this.var_774 == GeometryType.const_1279 && param1 == GeometryType.const_1233)
         {
            this.var_774 = param1;
            this.var_100 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_274.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_370.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_779)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_496)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1481.getFigure(),_loc5_,this.var_774,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_496 = _loc10_.getImageContainer(_loc4_);
         if(this.var_496 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_496 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_370);
            if(this.var_496 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_496,_loc4_);
         }
         this.var_496.offset = _loc8_;
         return this.var_496;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_274.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_274.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_100)
         {
            ...
            this.var_2375 = new Point(0,this.var_100.height - int(this.var_100.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_1010 || _loc10_ == AvatarAction.const_413;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1453 = this.var_127.bodyPartId;
               this.var_195 = this.var_127.partType;
               this.var_1779 = this.var_127.partId;
               this._frame = this.var_127.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_195 == "lh" || this.var_195 == "ls" || this.var_195 == "lc" || this.var_195 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_195 == "rh" || this.var_195 == "rs" || this.var_195 == "rc" || this.var_195 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_195 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_195 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_195 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_127.flippedPartType != this.var_195)
                     {
                        this.var_195 = this.var_127.flippedPartType;
                     }
                  }
               }
               this.var_1452 = this._scale + "_" + this.var_127.action.assetPartDefinition + "_" + this.var_195 + "_" + this.var_1779 + "_" + _loc5_ + "_" + this._frame;
               this.var_439 = this._assets.getAssetByName(this.var_1452) as BitmapDataAsset;
               if(this.var_439 == null)
               {
                  this.var_1452 = this._scale + "_std_" + this.var_195 + "_" + this.var_1779 + "_" + _loc5_ + "_0";
                  this.var_439 = this._assets.getAssetByName(this.var_1452) as BitmapDataAsset;
               }
               if(!(!this.var_439 || !this.var_439.content))
               {
                  ...
                  {
                     this.var_987 = this._structure.renderManager.paletteManager.getPalette(this.var_127.paletteMapId);
                     if(this.var_987 != null)
                     {
                        this.var_957 = this.var_439.content as BitmapData;
                        this.var_196 = new BitmapData(this.var_957.width,this.var_957.height);
                        this.var_2374 = this.var_987.colorize(this.var_957.getPixels(this.var_957.rect));
                        this.var_196.setPixels(this.var_196.rect,this.var_2374);
                     }
                     else
                     {
                        this.var_196 = (this.var_439.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1453 == AvatarBodyPartType.const_253 || this.var_1453 == AvatarBodyPartType.const_1779 || this.var_1453 == AvatarBodyPartType.const_1872) && this.var_127.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_196.colorTransform(this.var_196.rect,this.var_127.color.colorTransform);
                  }
                  if(this.var_127.isBlendable)
                  {
                     this.var_196.colorTransform(this.var_196.rect,this.var_127.blendTransform);
                  }
                  this.var_956 = this.var_439.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_62)
                     {
                  ...
                  this.var_2376 = new ImageData(this.var_196,this.var_956,_loc7_);
                  this.var_955.push(this.var_2376);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.method_7(this.var_955,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2375.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_62)
            {
      ...
      private function method_7(param1:Array, param2:Boolean) : ImageData
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
