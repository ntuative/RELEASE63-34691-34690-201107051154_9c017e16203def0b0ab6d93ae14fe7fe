package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private var var_394:IBitmapWrapperWindow;
      ...
      private function createView() : void
      {
         ...
         this.var_394 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1569)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_117,this.var_1034,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_43,parseInt(FigureData.const_929));
         ...
         if(this.var_394)
         {
            if(this.var_394.bitmap)
            {
               this.var_394.bitmap.dispose();
            }
            this.var_394.bitmap = new BitmapData(this.var_394.width,this.var_394.height,true,0);
            _loc7_ = (this.var_394.width - _loc1_.width) / 2;
            _loc8_ = (this.var_394.height - _loc1_.height) / 2;
            this.var_394.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1034 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1989,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_27.loadAvatarInEditor(this._figure,this.var_1034,this.var_27.clubMemberLevel);
               }
         }
      }
