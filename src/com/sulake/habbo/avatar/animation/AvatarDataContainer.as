package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_2106 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2921 = parseInt(_loc2_,16);
         this.var_2923 = parseInt(_loc3_,16);
         ...
         this.var_909 = new ColorTransform(this.var_2039,this.var_2037,this.var_2038,this._alphaMultiplier);
         this.var_1344 = this.generatePaletteMapForGrayscale(this.var_2923,this.var_2921);
      }
      ...
      {
         return this.var_1344.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1344.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1344.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1344.getValue("alphas") as Array;
      }
