package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_1154:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2106 = parseInt(param2.@ink);
         this.var_3023 = String(param2.@member);
         this.var_3022 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1690 = [];
         this.var_1689 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1690[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1689[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1690.length)
         {
            return this.var_1690[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1689.length)
         {
