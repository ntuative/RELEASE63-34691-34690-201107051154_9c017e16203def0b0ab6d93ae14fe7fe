package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1565:String = "Default";
      
      private static const const_1567:int = 2;
      
      private static const const_1566:String = AvatarSetType.const_43;
      ...
      private var var_2920:String = null;
      
      private var var_2919:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_274 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1566,const_1567);
         this.var_361 = new Array();
         this.var_1052 = new ActiveActionData(AvatarAction.const_422);
         this.var_1052.definition = this._structure.getActionDefinition(const_1565);
         this.resetActions();
      ...
      {
         param2 += this.var_2017;
         if(param2 < AvatarDirectionAngle.const_1223)
         {
            param2 = AvatarDirectionAngle.const_325 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_325)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_715,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_299.length == 1 && this.var_103 == this.var_1908)
         {
            return this.var_103 + this.var_584 + this.var_715 % 4;
         }
         if(this.var_299.length == 2)
         {
            for each(_loc1_ in this.var_299)
            {
               ...
               {
                  return this.var_103 + this.var_584 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_715 % 11;
                  return this.var_103 + "_" + this.var_1908 + this.var_584 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2918 || param2 != this.var_2920 || param1 != this.var_2919)
         {
            this.var_2918 = param3;
            this.var_2920 = param2;
            this.var_2919 = param1;
            this.var_2105 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1427 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1427)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_715);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_715);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2,this.var_715));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_1052;
         this.var_315.definition = this.var_1052.definition;
         this.resetBodyPartCache(this.var_1052);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_584 = "";
         this.var_299 = this._structure.sortActions(this.var_361);
         if(this.var_299 == null)
         {
            this.var_821 = new Array(0,0,0);
            if(this.var_1343 != "")
            {
               _loc1_ = true;
               this.var_1343 = "";
         ...
         {
            this.var_821 = this._structure.getCanvasOffsets(this.var_299,this._scale,this.var_103);
            for each(_loc4_ in this.var_299)
            {
               this.var_584 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_359)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1636 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1343 != this.var_584)
            {
               _loc1_ = true;
               this.var_1343 = this.var_584;
            }
         }
         this.var_1594 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_299)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1022 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_219 = this.var_219.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_2017 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_363 || _loc1_.actionType == AvatarAction.const_298 || _loc1_.actionType == AvatarAction.const_413)
               {
                  this.var_1022 = true;
               }
            }
