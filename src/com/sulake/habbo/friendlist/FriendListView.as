package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1453:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1829:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1829 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1453;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1009 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_292 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1829.prepare(this.var_1009);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1357,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1379,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_979,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_964,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_979,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_964,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1487 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1487.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1830 == -1 ? 0 : int(this.var_16.height - this.var_1830);
         var _loc4_:int = this.var_1831 == -1 ? 0 : int(this.var_16.width - this.var_1831);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_292.y = Util.getLowestPoint(this.var_16.content);
         this.var_292.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1186,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_979,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1357,false);
         ...
         this.var_1830 = this.var_16.height;
         this.var_1831 = this.var_16.width;
