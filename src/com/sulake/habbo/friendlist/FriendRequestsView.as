package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2102:String = "no_reqs_info";
      ...
      private var var_2123:IContainerButtonWindow;
      
      private var var_2124:IContainerButtonWindow;
      ...
      {
         this.var_2123 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2124 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2124.procedure = this.onDismissAllButtonClick;
         this.var_2123.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_402)
         {
         ...
         else if(param1.state == FriendRequest.const_1267)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_62.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_62.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_402;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_402 && _loc2_.state != FriendRequest.const_396)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_234,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_402 && _loc2_.state != FriendRequest.const_396)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_234,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2123,_loc1_);
         this.setEnabled(this.var_2124,_loc1_);
      }
