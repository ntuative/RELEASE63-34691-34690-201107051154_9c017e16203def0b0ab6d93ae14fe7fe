package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2255:int = "F".charCodeAt(0);
      
      public static const const_2326:int = "M".charCodeAt(0);
      ...
      private var var_1209:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_809 = param1.online;
         this.var_1840 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1841 = param1.motto;
         this.var_1838 = param1.lastAccess;
         this.var_1565 = param1.categoryId;
         this.var_1839 = param1.realName;
