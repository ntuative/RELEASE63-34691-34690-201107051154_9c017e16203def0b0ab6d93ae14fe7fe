package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_158:IHabboMessenger;
      ...
      private var var_801:ISessionDataManager;
      
      private var var_2582:FriendListLookAndFeel;
      
      private var var_476:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1898:OpenedToWebPopup;
      
      private var var_2334:int;
      
      var var_118:FriendCategories;
      
      private var var_119:FriendRequests;
      
      private var var_1897:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1049:IHabboNotifications;
      
      private var var_655:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2582 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1897 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_655.stop();
            this.var_655.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_655 = null;
         }
         ...
         if(this.var_158)
         {
            this.var_158.release(new IIDHabboMessenger());
            this.var_158 = null;
         }
         if(this.var_138)
         {
         ...
         if(this.var_1049)
         {
            this.var_1049.release(new IIDHabboNotifications());
            this.var_1049 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_801)
         {
            this.var_801.release(new IIDSessionDataManager());
            this.var_801 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1898 = new OpenedToWebPopup(this);
         }
         this.var_1898.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_110);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_93);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_448);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_343,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         queueInterface(new IIDHabboMessenger(),this.method_8);
      }
      
      private function method_8(param1:IID = null, param2:IUnknown = null) : void
      {
         Logger.log("Friend list: messenger available " + [param1,param2]);
         this.var_158 = param2 as IHabboMessenger;
      ...
      {
         this.var_1049 = param2 as IHabboNotifications;
      ...
      {
         this.var_801 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_118.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1336,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_407,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_476 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_655)
         {
            this.var_655 = new Timer(120000);
            this.var_655.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_655.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_407);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_119.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_119.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_476.findTab(FriendListTab.const_93).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_476.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1897.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_476.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_476.findTab(FriendListTab.const_93);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_801 || !this.var_119)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_801.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_119.vipLimit;
         }
         else if(this.var_801.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_119.clubLimit;
         }
         if(_loc2_ > this.var_119.limit)
         {
            this.var_119.limit = _loc2_;
         }
      }
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_190) as IBitmapWrapperWindow;
