package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1918:String = "sample_44khz";
      
      public static const const_1805:String = "sample_22khz";
      
      public static const const_1817:String = "sample_11khz";
      
      public static const const_1920:String = "sample_16bit";
      
      public static const const_1854:String = "sample_8bit";
      ...
      private var var_136:Vector.<int> = null;
      
      private var _id:int;
      
      private var var_182:int = 2;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_182 * this.var_85;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_136 = new Vector.<int>(_loc7_ / _loc6_,true);
         var _loc8_:Number = 1 / (Number(_loc5_) / 2);
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc10_:int = _loc7_ / this.var_85;
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1096)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1096);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_182 == this.var_182 - 1)
            {
               this.var_136[int(_loc11_ / this.var_182)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_136.length * this.var_182 * this.var_85;
      }
      
      public function get usageCount() : int
      {
         return this.var_677.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_136 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_182 * this.var_85;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_136.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_136.length - param4)) * _loc5_;
            _loc6_ = this.var_136.length - param4;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_677.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_677.indexOf(param1) != -1;
      }
   }
}
