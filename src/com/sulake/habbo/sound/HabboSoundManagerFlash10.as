package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1564:int = 60;
      
      private static const const_1563:int = 25165823;
      
      private static const const_1562:int = 16777215;
      ...
      private var var_1051:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1050 = new Map();
         this.var_1305 = new Map();
         this.var_1591 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_975,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1050.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1399:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1771:
            ...
            this.var_1050.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1051;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_138.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_138.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_692.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1305.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_293,events);
         _loc5_.volume = this.var_1051;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_293.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1049.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_138.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2777 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1049 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_138 == null || this._connection == null || this._roomEngine == null || this.var_243 != null)
         {
            return;
         }
         this.var_243 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_243.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1831,this.var_863));
         this.var_863 = -1;
         this.var_862 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1051 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_243.updateVolume(this.var_1051);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_692.getValue(param1) != null)
         {
            _loc2_ = this.var_692.remove(param1);
            if(this.var_293.getValue(_loc2_) == null)
            {
               this.var_1591.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1591,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1591,_loc2_,TraxSample.const_1918,TraxSample.const_1920);
               this.var_293.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1304.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1564 && this.var_1304.length > 0)
            {
               _loc3_ = this.var_1304.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_692.length == 0 && this.var_863 != -1)
            {
               this.var_862.ready = true;
               _loc4_ = this.var_863;
               this.var_863 = -1;
               this.var_862 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_975,_loc4_));
               if(this.var_2777)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_862 == null && this.var_1305.length > 0)
         {
            _loc1_ = this.var_1305.getKey(0);
            _loc2_ = this.var_1305.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_975,_loc1_));
               }
               else
               {
                  this.var_862 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_243.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_293.length)
         {
            _loc5_ = this.var_293.getKey(_loc4_);
            _loc6_ = this.var_293.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1563)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1562 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_293.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_293.remove(_loc11_);
               }
               this.var_243.samplesUnloaded(_loc7_);
            }
         }
      }
