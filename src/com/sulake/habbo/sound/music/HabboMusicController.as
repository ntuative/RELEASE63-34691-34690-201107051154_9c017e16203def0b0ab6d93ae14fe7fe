package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1437:int = HabboMusicPrioritiesEnum.const_136;
      ...
      private var var_95:IEventDispatcher;
      ...
      private var var_531:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_770.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_770.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_770)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_734,this.onJukeboxInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_280,this.onJukeboxDispose);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_864,this.onSoundMachineInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_730,this.onSoundMachineDispose);
         this.var_1192 = new Timer(1000);
         this.var_1192.start();
         this.var_1192.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_296)
         {
            this.var_325[_loc6_] = null;
            this.var_781[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1810)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_445)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_770)
               {
            ...
            if(this.var_276)
            {
               ...
               {
                  _loc3_ = this.var_276.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_734,this.onJukeboxInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_280,this.onJukeboxDispose);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_864,this.onSoundMachineInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_730,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_325[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_325[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_781[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_325.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_325[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_276.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_296)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_634.add(param1,param2);
      ...
      {
         return this.var_372.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_372.length)
         {
            return this.var_372.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_372.length)
         {
            return this.var_372.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_276.length)
         {
            ...
            if(_loc3_.id != this.var_1473 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_325[_loc2_] != null)
            {
               _loc3_ = this.var_325[_loc2_];
               _loc4_ = this.var_276.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_780));
         Logger.log("Requested song info\'s : " + this.var_780);
         this.var_780 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_276.add(_loc6_.id,_loc10_);
               ...
               while(this.var_782.indexOf(_loc6_.id) != -1)
               {
                  this.var_782.splice(this.var_782.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_296)
         {
            return false;
         }
         ...
         this.var_1810 = this.getSongRequestCountAtPriority(param1);
         this.var_1473 = param2;
         if(this._priorityPlaying <= const_1437)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_136)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2416 != param1.id || _loc3_ > this.var_2415 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2416 = param1.id;
            this.var_2415 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_372.add(_loc5_,_loc6_);
            if(this.var_276.getValue(_loc6_) == null)
            {
               this.var_782.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_531 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_95,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_531 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
