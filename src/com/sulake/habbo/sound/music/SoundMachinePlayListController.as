package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_243:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_243 = param2;
         this.var_770 = [];
         this.var_770.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_770.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_770)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_797,this.onSoundMachinePlayEvent);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_813,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_797,this.onSoundMachinePlayEvent);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_813,this.onSoundMachineStopEvent);
               this.var_95 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_475);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_243.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_475 = -1;
         this.var_706 = false;
         this.var_243.stop(HabboMusicPrioritiesEnum.const_136);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_243.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_243.playSong(param1,HabboMusicPrioritiesEnum.const_136,_loc3_,0,0,0))
         {
