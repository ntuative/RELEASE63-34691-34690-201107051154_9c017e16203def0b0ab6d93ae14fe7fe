package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_682:Number = 0.0;
      ...
      {
         return int(this.var_1758 * (Number(param1 - this._minValue) / (this.var_1282 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1758 * (this.var_1282 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1035)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_303)
            {
               this.var_1035 = false;
            }
         }
         if(!this.var_1035 || param1.type != WindowEvent.const_439)
         {
            return;
         }
         if(this.var_682 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_682) * this.var_682;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_682 != 0)
            {
               _loc3_ = this.var_1036 + this.var_682;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_773 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_773.width,this.var_773.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_773,this.var_773.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_772 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_772.width,this.var_772.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_772,this.var_772.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1758 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_773 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_772 = BitmapData(_loc2_.content);
      }
   }
}
