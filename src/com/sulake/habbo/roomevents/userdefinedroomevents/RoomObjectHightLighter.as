package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_95.roomEngine.getRoomObject(this.var_95.roomId,this.var_95.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
