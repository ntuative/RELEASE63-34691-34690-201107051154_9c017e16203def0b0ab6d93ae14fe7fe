package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1052:uint = 11;
      ...
      private var var_353:IAdManager;
      ...
      private var var_207:IHabboHelp;
      ...
      private var var_437:FramerateTracker = null;
      
      private var var_273:LatencyTracker = null;
      
      private var var_631:LagWarningLogger = null;
      
      private var var_438:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_437 = new FramerateTracker();
         this.var_273 = new LatencyTracker();
         this.var_631 = new LagWarningLogger();
         this.var_438 = new ToolbarClickTracker(this);
         this.var_1451 = new Array(const_1052);
         var _loc4_:int = 0;
         while(_loc4_ < const_1052)
         {
            this.var_1451[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1992,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1882,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1997,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1011,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1182,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_366,this.onZoomToggle);
               }
            ...
            if(this.var_211)
            {
               if(!this.var_211.disposed)
               {
                  ...
                  Component(this.var_211).events.removeEventListener(HabboFriendListTrackingEvent.const_523,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_207)
            {
               if(!this.var_207.disposed)
               {
                  this.var_207.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_207.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_207.release(new IIDHabboHelp());
               this.var_207 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_360,this.onRoomAction);
               }
      ...
      {
         this.var_1451[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_138 = IHabboConfigurationManager(param2);
         if(this.var_138)
         {
            if(this.var_273 != null)
            {
               this.var_273.configuration = this.var_138;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_138;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1840);
            if(this.var_138)
            {
               if(this.var_631 != null)
               {
                  this.var_631.configure(this.var_138);
               }
               if(this.var_437 != null)
               {
                  this.var_437.configure(this.var_138);
               }
               if(this.var_438 != null)
               {
                  this.var_438.configure(this.var_138);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_875,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_291,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_204,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_209,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_312,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_920,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_612,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_920)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1950);
         }
         else if(param1.type == HabboHotelViewEvent.const_612)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1878);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1852);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1739);
               break;
            case HabboCommunicationEvent.const_875:
               this.trackLoginStep(HabboLoginTrackingStep.const_2025,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_291:
               this.trackLoginStep(HabboLoginTrackingStep.const_291);
               break;
            case HabboCommunicationEvent.const_209:
               this.trackLoginStep(HabboLoginTrackingStep.const_209);
               break;
            case HabboCommunicationEvent.const_204:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_204);
               break;
            case HabboCommunicationEvent.const_312:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_312);
               if(this.var_273 != null)
               {
                  this.var_273.init();
               }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_138)
            {
               if(this.var_138.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_138.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1451)
                  {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1271,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_366,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_211).events.addEventListener(HabboFriendListTrackingEvent.const_523,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_523:
      ...
      {
         this.var_207 = param2 as IHabboHelp;
         this.var_207.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_207.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2371)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1869);
            this.var_2371 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1182,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1011,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_360,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_353 = param2 as IAdManager;
         this.var_353.events.addEventListener(AdEvent.const_524,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_360)
         {
            if(this.var_322)
            {
               this.var_322.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_437)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_437.frameRate),_loc2_);
                  ++this.var_1777;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_438)
         {
            this.var_438.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_438)
         {
            this.var_438.track(param1.type);
         }
      }
      ...
      {
         if(this.var_138 != null && !Boolean(this.var_138.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_525 > -1 && _loc2_ < this.var_525)
         {
            ++this.var_1778;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1778);
         }
         if(this.var_525 > -1 && _loc2_ - this.var_525 > 15000)
         {
            ++this.var_1776;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1776);
         }
         this.var_525 = _loc2_;
         if(this.var_272 != null)
         {
            this.var_272.update(param1,this.var_525);
         }
         if(this.var_273 != null)
         {
            this.var_273.update(param1,this.var_525);
         }
         if(this.var_437 != null)
         {
            this.var_437.trackUpdate(param1,this,this.var_525);
         }
         if(this.var_631 != null)
         {
            this.var_631.update(this.var_525);
         }
      }
   }
}
