package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_259:Timer;
      
      private var var_404:AdImageRequest;
      
      private var var_1320:BitmapData = null;
      ...
      {
         this.var_281 = param2 as IHabboCommunicationManager;
         if(this.var_281 == null)
         {
            return;
         }
         this._connection = this.var_281.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2840 = this._config.getKey("interstitial.enabled","ICaption") == "true";
         this.var_2842 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2843 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2062 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_259 != null && this.var_259.running)
         {
            this.var_259.reset();
            return false;
         }
         ...
         if(this.var_2062 > 0 && this.var_2061 >= this.var_2062)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1319;
         if(_loc1_ > this.var_2842)
         {
            ++this.var_2061;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1615 = _loc2_.imageUrl;
         this.var_2841 = _loc2_.clickUrl;
         this.var_1319 = getTimer();
         if(this.var_1615 != "")
         {
            _loc3_ = this.var_1615;
            ...
            {
               this.var_259 = new Timer(this.var_2843,1);
               this.var_259.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_259.running)
            {
               this.var_259.reset();
            }
            this.var_259.start();
            _loc4_ = new URLRequest(this.var_1615);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_551,param1.bitmapData,this.var_2841));
            this.var_1319 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_617));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_404 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_404 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_404 = new AdImageRequest(this.var_404.roomId,this.var_404.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_404 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_524,this.var_404.roomId,this.var_404.roomCategory,_loc4_,_loc2_.assetName,this.var_404.clickURL,this.var_1320,this.var_1318));
            this.var_404 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1320 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_705.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_705.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_705.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_987,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_705.remove(_loc2_.assetName);
