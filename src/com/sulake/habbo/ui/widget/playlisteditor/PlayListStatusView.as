package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_741:String = "PLSV_ADD_SONGS";
      
      public static const const_1342:String = "PLSV_START_PLAYBACK";
      
      public static const const_659:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_659)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_478[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_478[const_741];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_478.add(const_659,_loc1_);
