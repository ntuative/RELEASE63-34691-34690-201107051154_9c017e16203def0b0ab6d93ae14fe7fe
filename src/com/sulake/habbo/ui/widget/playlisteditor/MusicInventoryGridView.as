package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_696:IItemGridWindow;
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_696.destroyGridItems();
            this.var_696 = null;
         }
         if(this.var_243 != null)
         {
            if(this.var_243.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this.var_696.removeGridItems();
         var _loc1_:Map = this._items;
         var _loc2_:Map = new Map();
         var _loc3_:Array = _loc1_.getKeys();
         this._items = new Map();
         var _loc4_:int = this.var_243.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_243.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_243.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_243.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_696.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_116.playButtonState = MusicInventoryGridItem.const_1285;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_116 != null)
         {
            this.var_116.playButtonState = MusicInventoryGridItem.const_597;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_172;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_116.playButtonState == MusicInventoryGridItem.const_597)
               {
                  this.var_116.playButtonState = MusicInventoryGridItem.const_1311;
            ...
            {
               _loc4_ = this.var_696.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
