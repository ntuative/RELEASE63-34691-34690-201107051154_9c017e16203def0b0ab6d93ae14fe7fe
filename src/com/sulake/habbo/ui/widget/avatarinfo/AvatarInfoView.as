package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1033:uint = 4282950861;
      ...
      protected static const const_2054:uint = 16777215;
      
      protected static const const_2057:uint = 5789011;
      
      protected static const const_2053:uint = 13947341;
      
      protected static const const_2056:uint = 5789011;
      
      private static const const_1683:int = 25;
      ...
      protected var var_2271:FixedSizeStack;
      
      protected var var_2272:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_514:Timer;
      
      protected var var_3065:int = 3000;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_2534 = param4;
         param1.var_2270 = param6;
         param1.var_1708 = false;
         param1.var_3064 = 500;
         param1.var_1707 = false;
         param1._blend = 1;
         if(param1.var_1153)
         {
            if(!param1.var_514)
            {
               param1.var_514 = new Timer(param1.var_3065,1);
               param1.var_514.addEventListener(TimerEvent.TIMER_COMPLETE,param1.onTimerComplete);
            }
            param1.var_514.reset();
            param1.var_514.start();
         }
         param1.updateWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_514)
         {
            this.var_514.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_514.reset();
            this.var_514 = null;
         }
         this._disposed = true;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_643));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1707)
         {
            ...
            this._blend = 1 - this.var_1709 / Number(this.var_3064);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_2122 || this.var_2143)
         {
            _loc4_ = -this.var_192.height;
            if(this.var_1710 == RoomObjectTypeEnum.const_131 || this.var_1710 == RoomObjectTypeEnum.const_610)
            {
            ...
            this.var_2271.addValue(_loc5_);
            _loc6_ = this.var_2271.getMax();
            if(_loc6_ < this.var_2272 - const_1151)
            {
               _loc6_ = this.var_2272 - const_1151;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2272 = _loc6_;
