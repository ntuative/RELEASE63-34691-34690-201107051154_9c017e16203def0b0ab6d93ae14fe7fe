package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_241:AvatarInfoData;
      ...
      private var var_3066:Boolean;
      
      private var var_763:AvatarInfoView;
      ...
      private var var_1725:Boolean = true;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_138 = param4;
         this.var_241 = new AvatarInfoData();
         this.var_2278 = Boolean(this.var_138.getBoolean("menu.avatar.enabled",false));
         this.var_1724 = this.var_138.getBoolean("menu.own_avatar.enabled",false);
         this.var_365 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_199,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_437,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_285,this.onEffectsChanged);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_960,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_199,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_437,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_285,this.onEffectsChanged);
         this._view = null;
         this.var_138 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_164,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_375,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetUserDataUpdateEvent.const_127,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_193,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_635,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_943,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_164,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_375,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetUserDataUpdateEvent.const_127,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_193,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_635,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_125:
               ...
               if(this.var_1724 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_635:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_375:
               this.var_1725 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_354:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_943:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1726 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_735,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_410:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1726)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_164:
               _loc3_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.storeUserInfo(_loc3_);
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_131,false,!!_loc3_.isSpectatorMode ? null : this.var_241);
               break;
            ...
            case RoomWidgetPetInfoUpdateEvent.const_114:
               if(this.var_1725)
               {
                  ...
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_223,false,null);
               }
               break;
            case RoomWidgetUserDataUpdateEvent.const_127:
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_193:
               ...
               for each(_loc7_ in this.var_365)
               {
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_378,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_241.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_241.amIController = param1.amIController;
         this.var_241.amIOwner = param1.amIOwner;
         this.var_241.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_241.canBeKicked = param1.canBeKicked;
         this.var_241.canTrade = param1.canTrade;
         this.var_241.canTradeReason = param1.canTradeReason;
         this.var_241.hasFlatControl = param1.hasFlatControl;
         this.var_241.isIgnored = param1.isIgnored;
         this.var_241.respectLeft = param1.respectLeft;
         this.var_241.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_115;
         this.var_241.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1724) : Boolean(this.var_2278);
         }
            ...
            if(!this.var_1723)
            {
               if(_loc7_)
               {
                  ...
                  else
                  {
                     ...
                     for each(_loc8_ in this.var_365)
                     {
               ...
               else
               {
                  if(!this.var_763)
                  {
                     this.var_763 = new AvatarInfoView(this);
                  }
                  this._view = this.var_763;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_365.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_365.length > 0)
         {
