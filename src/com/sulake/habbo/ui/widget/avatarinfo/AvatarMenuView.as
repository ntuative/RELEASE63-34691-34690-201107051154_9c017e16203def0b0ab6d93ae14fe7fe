package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1034:uint = 1;
      
      protected static const const_1035:uint = 2;
      
      protected static var var_1431:uint = const_1034;
      
      private static const const_1696:uint = 16744755;
      
      private static const const_1697:uint = 16756591;
      
      private static const const_1049:int = 8;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_708:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1711)
         {
            ...
            {
               this.var_708 = const_1035;
            }
            else
            {
               this.var_708 = var_1431;
            }
         }
         if(this.var_708 == const_1034)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1049;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1049;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2055) : uint(const_1033);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1697;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1696;
               }
            }
         }
         if(_loc3_)
