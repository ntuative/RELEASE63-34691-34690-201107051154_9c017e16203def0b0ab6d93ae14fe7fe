package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1124:MeMenuSoundSettingsSlider;
      ...
      private var var_1126:BitmapData;
      ...
      {
         this.var_1051 = param1.volume;
         if(this.var_1124 != null)
         {
            this.var_1124.setValue(this.var_1051);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1125 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1123 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1127 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1126 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1124 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_957));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1051 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1126);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1125);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1127);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1123);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_965);
         }
