package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1747:String = "POLL_OFFER_STATE_OK";
      
      public static const const_940:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_113:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_113)
         {
            return;
         }
         this._state = const_1747;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_804,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_940;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_657,this._id));
