package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1368:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_592 = new PollOfferDialog(this._id,param1,this.var_1368);
         this.var_592.start();
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_591 = new PollContentDialog(this._id,param1,param3,this.var_1368);
         this.var_591.start();
      }
      ...
      {
         this.var_1368.windowManager.alert("${poll_thanks_title}",this.var_1813,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
