package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2341:int = 5;
      
      private const const_2342:int = 5;
      ...
      private var var_1186:Rectangle = null;
      
      private var var_3068:int = 0;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1185 = 0;
         this.var_1186 = param2.rectangle.clone();
         this.var_1186.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1186.width)
         {
            return false;
         }
         if(this.var_1185 + param1.height > this.var_1186.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1186.width)
         {
            this._offsetX = 0;
            this.var_1185 += param1.height + this.const_2342;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1185);
         this._offsetX += param1.width + this.const_2341;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1459 != null && this.var_1459.indexOf(param1) != -1)
         {
