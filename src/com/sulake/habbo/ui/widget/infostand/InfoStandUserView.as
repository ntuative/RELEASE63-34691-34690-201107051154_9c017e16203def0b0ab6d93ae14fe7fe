package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1105:TagListRenderer;
      ...
      private const const_1084:int = 5;
      
      private const const_2350:int = 3;
      
      private const const_1484:int = 11184810;
      
      private const const_1483:int = 16777215;
      
      private const const_2353:int = 2000;
      
      private const const_2351:int = 50;
      
      private const const_2352:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1105 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2584 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_46.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_46.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc7_ = this.var_46.findChildByName("badge_" + _loc8_);
            if(_loc7_ != null)
            {
         ...
         _loc7_ = this.var_46.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1084;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1484;
            }
            else
            {
               _loc5_.textColor = this.const_1483;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1084,this.const_2351);
         _loc5_.height = Math.max(_loc5_.height,this.const_2352);
         _loc3_.height = _loc5_.height + this.const_2350;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_370,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_370,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1105.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_115);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_829:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_776:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2583 > this.const_2353 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2583 = _loc6_;
               _loc3_.textColor = this.const_1483;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1484;
         }
      }
