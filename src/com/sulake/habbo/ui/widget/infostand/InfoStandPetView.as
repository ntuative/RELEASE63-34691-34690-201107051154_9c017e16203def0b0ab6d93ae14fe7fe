package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1581:int = 162;
      
      private static const const_1574:int = 16;
      
      private static const const_712:int = 4;
      
      private static const const_1578:uint = 14342874;
      
      private static const const_1576:uint = 3815994;
      
      private static const const_1575:uint = 2085362;
      
      private static const const_1572:uint = 39616;
      
      private static const const_1579:uint = 10513106;
      
      private static const const_1582:uint = 8734654;
      
      private static const const_1577:uint = 9094430;
      
      private static const const_1583:uint = 6200576;
      
      private static const const_1585:String = "happiness";
      
      private static const const_1584:String = "experience";
      
      private static const const_1580:String = "energy";
      
      private static const const_1573:int = 250;
      
      private static const const_1112:int = 25;
      ...
      private var var_227:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_46 == null || this.var_109 == null)
         {
            return;
         }
         ...
         this.var_46.height = this.var_55.height + 20;
         this._window.width = Math.max(this.var_46.width,this.var_109.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_109.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1585,param1.nutrition,param1.nutritionMax,const_1572,const_1575);
         this.updateStateElement(const_1584,param1.experience,param1.experienceMax,const_1582,const_1579);
         this.updateStateElement(const_1580,param1.energy,param1.energyMax,const_1583,const_1577);
         ...
         if(this.var_227 && this.var_227.isVisible() && param1.isOwnPet)
         {
            this.var_227.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_227.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1581,const_1574,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1578);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1576);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_712,_loc7_.width - 2,_loc7_.height - 2 - const_712);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_712);
      ...
      private function openTrainView() : void
      {
         if(this.var_227 == null)
         {
            this.var_227 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_570) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_227.showWindow(true);
            this.var_227.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_55 = this.var_46.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_227 && this.var_227.getPetId() == this.var_570)
               {
                  this.var_227.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1841,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_455,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1112 + const_1113;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1113;
            }
         }
         this.var_109.height = _loc4_ + const_1112;
         this.updateWindow();
      }
   }
}
