package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_46:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_269 = this.var_46.findChildByTag("catalog");
         if(this.var_269 != null)
         {
            this.var_269.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboNavigatorCom_rico_top3_png":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_55 == null || this.var_46 == null || this._buttons == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_46.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this._buttons.width)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1206 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_510 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboNavigatorCom_rico_top3_png",_loc6_);
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_184,this.adElementKeyEventProc);
                  }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1304.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function getVisibleAdFurnitureExtraParams() : String
      {
         ...
         {
            _loc2_ = [];
            this.var_46.groupChildrenWithTag("branding_element",_loc2_,true);
            if(_loc2_.length > 0)
            {
      ...
      private function showAdFurnitureDetails(param1:Boolean) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this._widget == null || this.var_46 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_46.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:* = [];
         this.var_46.groupChildrenWithTag("branding_element",_loc3_,true);
         if(_loc3_.length > 0)
         {
            for each(_loc8_ in _loc3_)
            {
               this.var_46.removeChild(_loc8_);
               _loc8_.dispose();
            }
         }
         var _loc4_:Boolean = false;
         var _loc5_:IWindow = this.var_46.findChildByName("furni_details_text") as ITextWindow;
         if(_loc5_ != null)
         {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_55.addListItem(this.var_269);
            }
            this.var_269.visible = param1;
         }
         else
         {
            this.var_55.removeListItem(this.var_269);
         }
      }
   }
}
