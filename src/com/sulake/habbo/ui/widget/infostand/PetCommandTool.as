package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_2370:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_400 = new Timer(this.const_2370);
         this.var_400.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1307.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1307.getValue(this.var_570) as CommandConfiguration;
      ...
      {
         this.var_1307.remove(param1);
         this.var_1307.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_1014,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_43 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_43 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_43.setParamFlag(WindowParam.const_104,true);
         this.var_43.context.getDesktopWindow().addEventListener(WindowEvent.const_40,this.onWindowDesktopResized);
         this.var_43.procedure = this.onCommandWindowProcedure;
         this.var_43.position = const_1453;
      }
      ...
      private function updateCommandButtonsViewState(param1:CommandConfiguration) : void
      {
         ...
         var _loc2_:IWindowContainer = IWindowContainer(this.var_43.findChildByName("commands_container"));
         hideChildren(_loc2_);
         ...
         this.var_43.height = _loc2_.height + 160;
         this.var_400.stop();
      }
      ...
      private function disableAllButtons() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_43.findChildByName("commands_container"));
         var _loc2_:int = 0;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_283,this.var_570));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_634,this.var_570,this.var_2036 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_634,this.var_570,this.var_2036 + " " + _loc5_);
