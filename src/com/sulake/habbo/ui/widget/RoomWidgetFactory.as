package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3096 = param1.root.assets;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_48)
         {
            this.var_48.release(new IIDHabboQuestEngine());
            this.var_48 = null;
         }
         if(this._roomEngine)
         {
      ...
      private function onQuestEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_48 = param2 as IHabboQuestEngine;
      }
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_462:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_77,this.var_153,this.var_3004++,this);
               break;
            case RoomWidgetEnum.const_323:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_77,this.var_153,this);
               break;
            case RoomWidgetEnum.const_501:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_77,this.var_153,this._catalog);
               break;
            case RoomWidgetEnum.const_525:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_77,events,this.var_153);
               break;
            ...
            case RoomWidgetEnum.const_608:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_77,this.var_153,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_542:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_77,this.var_153);
               break;
            case RoomWidgetEnum.const_489:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_77,this.var_153);
               break;
            case RoomWidgetEnum.const_133:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_77,this.var_153);
               break;
            ...
            case RoomWidgetEnum.const_125:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_153,this.var_77,this);
               break;
            ...
            case RoomWidgetEnum.const_607:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_77,this.var_153,this._catalog);
               break;
