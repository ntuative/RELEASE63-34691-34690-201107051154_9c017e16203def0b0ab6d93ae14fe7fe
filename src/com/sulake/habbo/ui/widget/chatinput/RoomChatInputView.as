package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1515:int = 250;
      
      private static const const_1517:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1516:String = "${widgets.chatinput.say}";
      ...
      private var var_1945:IWindow;
      
      private var _button:IWindow;
      
      private var var_1946:IWindow;
      
      private var var_1548:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1254 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2670 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2669 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_384 = new Timer(1000,1);
         this.var_384.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_454 = new Timer(10000,1);
         this.var_454.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_454.reset();
            this.var_454.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_454 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1945 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1946 = this._window.findChildByName("send_button_text");
         this.var_1548 = this._window.findChildByName("block_text");
         this.var_1946.caption = const_1516;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_184,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_370,this.keyUpHandler);
         this.var_26.addEventListener(WindowEvent.const_116,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1549 = true;
         this.var_669 = "";
         this._window.addEventListener(WindowEvent.const_644,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_651,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1945.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1515 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1517);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1254 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_669 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_669.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_668);
