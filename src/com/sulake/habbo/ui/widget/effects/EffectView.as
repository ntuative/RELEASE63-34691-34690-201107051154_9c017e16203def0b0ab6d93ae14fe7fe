package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2380:int = 1000;
      ...
      private var var_745:IWindow;
      
      private var var_331:Number;
      
      private var var_600:ITextWindow;
      
      private var var_214:Timer;
      
      private var var_744:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_144 = param2;
         this._widget = param1;
         this.var_214 = new Timer(this.const_2380);
         this.var_214.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_214.stop();
            this.var_214.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_214 = null;
         }
         this._widget = null;
         this.var_144 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_144.isActive)
         {
            ...
            this.var_745.width = _loc2_ * this.var_331;
         }
         else
         {
            this.var_745.width = 0;
            this.var_214.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_600 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_600 == null)
            {
               return;
            }
         ...
         if(!this.var_144.isActive)
         {
            this.var_600.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_600.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_600.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_73,HabboWindowStyle.const_31,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_744 = this._window.findChildByName("effect_hilite");
            this.var_744.visible = false;
         }
         this.setTimeLeft();
         this.var_745 = this._window.findChildByName("loader_bar");
         if(this.var_745 != null)
         {
            this.var_331 = this.var_745.width;
            this.var_214.start();
            this.onUpdate();
         }
