package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_717:String = "welcome_gift_email_unverified";
      
      private const const_1137:String = "welcome_gift_email_verified";
      
      private const const_1608:String = "welcome_gift_email_change";
      
      private const const_2375:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1332)
         {
            this.setViewState(this.const_1137);
         }
         else
         {
            this.setViewState(this.const_717);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_717:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1080;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1080);
               break;
            case this.const_1137:
            ...
            case this.const_1608:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1080);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1628;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1608);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_850,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1332 ? this.const_1137 : this.const_717);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1629 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1629));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_508,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_925,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_508,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_925,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_508:
               this.var_1628 = param1.email;
               this.var_1332 = param1.isVerified;
               this.var_1080 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1628 = this.var_1629;
            this.setViewState(this.const_717);
         }
         else
         {
            if(param1.result == this.const_2375)
            {
               this.var_1080 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1629);
