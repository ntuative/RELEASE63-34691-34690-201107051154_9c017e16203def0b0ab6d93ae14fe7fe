package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2085:int = 0;
      
      private const const_2081:int = 1;
      
      private const const_2082:int = 2;
      
      private const const_2084:int = 3;
      
      private const const_2079:int = 4;
      
      private const const_2361:int = 0;
      
      private const const_2357:int = 1;
      
      private const const_2360:int = 2;
      
      private const const_2359:int = 3;
      
      private const const_2356:int = 4;
      
      private const const_2355:int = 5;
      
      private const const_2080:String = "deco_img";
      
      private const const_2083:String = "dialog_bg";
      
      private const const_2354:String = "%campaign%_dialog_bg.png";
      
      private const const_390:String = "%campaign%_gift_package.png";
      
      private const const_2358:String = "%campaign%_gift_content.png";
      
      private const const_2362:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1539 = this.var_153.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1539 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1542.length)
         {
            _loc2_ = this.var_1542.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_153 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_587,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_825,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_788,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_587,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_587:
               _loc2_ = this.const_2085;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_788:
               ...
               {
                  _loc2_ = this.const_2079;
               }
               this._shareId = null;
               this.var_1541 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_825:
         ...
         if(this._window && (this.var_1540 != _loc2_ || _loc3_ != this.var_206))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_206 = _loc3_;
         this.var_1540 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1540)
            {
               ...
               case this.const_2081:
                  ...
                  else if(this.var_430 == this.const_2357)
                  {
                     ...
                     _loc2_ = this.const_2358;
                  }
                  else if(this.var_430 == this.const_2360)
                  {
                  ...
                  else if(this.var_430 == this.const_2359)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_430 == this.const_2356)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_206,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_430 == this.const_2355)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2354.replace("%campaign%",this.var_206);
            this.setDecoImage(_loc5_,this.const_2083);
            _loc2_ = _loc2_.replace("%campaign%",this.var_206);
            this.setDecoImage(_loc2_,this.const_2080);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_764);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_192);
         ...
         if(this.var_12)
         {
            if(this.var_1541 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1541 == 1 ? "null" : InventoryCategory.const_121);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_816,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1542.push(new ImageDownloader(this,_assets,this.var_206,this.var_1539,param1,param2));
            return;
         }
