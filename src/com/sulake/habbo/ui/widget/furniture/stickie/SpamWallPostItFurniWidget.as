package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2254 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_638,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_638,this.onEditPostItRequest);
      }
      ...
      {
         hideInterface(false);
         var_238 = param1.objectId;
         this.var_501 = param1.location;
         var_1415 = param1.objectType;
         _text = "";
         var_359 = "FFFF33";
         var_27 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_238 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_781,var_238,this.var_501,_text,var_359);
