package com.sulake.habbo.ui.handler
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_323;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatTypingMessage.const_885);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatTypingMessage.const_885:
      ...
      {
         return [RoomSessionChatEvent.const_616];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_616:
