package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_770 = [];
         this.var_770.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_770.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_770)
         {
            return;
         }
         for each(_loc1_ in this.var_770)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_850);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_883);
         return _loc1_;
      }
