package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1680:IMessageEvent;
      
      private var var_2167:IMessageEvent;
      
      private var var_2168:IMessageEvent;
      ...
      {
         this.var_1680 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2167 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2168 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1680);
         this._connection.addMessageEvent(this.var_2167);
         this._connection.addMessageEvent(this.var_2168);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1680);
               this._connection.removeMessageEvent(this.var_2167);
               this._connection.removeMessageEvent(this.var_2168);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_867,RoomWidgetPlayListModificationMessage.const_992,RoomWidgetPlayListModificationMessage.const_998,RoomWidgetPlayListPlayStateMessage.const_732,RoomWidgetPlayListUserActionMessage.const_898];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_867:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_923,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_992:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_998:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_732:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_898:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_280:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_958,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1025,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1027));
               break;
