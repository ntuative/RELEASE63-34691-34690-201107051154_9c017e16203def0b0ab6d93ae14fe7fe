   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_373,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_285,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_369,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_844,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_373,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_285,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_369,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_844,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1609)
            {
               ...
               this.var_1609 = _loc3_;
               this.var_2053 = _loc1_;
               this.var_2052 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2053;
               _loc2_ = this.var_2052;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_481)
               {
                  ...
                  if(_loc2_.height > const_481 - const_1118)
                  {
                     _loc8_.offset(0,_loc2_.height - const_481 + const_1118);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_771);
         _loc1_.push(RoomWidgetDanceMessage.const_833);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_745);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1277);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1242);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1213);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_792);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_863);
         _loc1_.push(RoomWidgetStopEffectMessage.const_1004);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1985);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1165);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_511);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1926);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1355);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_847);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_841);
         _loc1_.push(RoomWidgetMeMenuMessage.const_995);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_957);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1919);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_897);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_965);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1266);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_431);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_841:
               ...
               break;
            case RoomWidgetWaveMessage.const_771:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_833:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_745:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1277:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1242:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_863:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1284)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_146,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_792:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1760:
                        this._catalog.openCatalogPage(CatalogPageName.const_1195,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1391:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_235);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1828:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2027:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1213:
            case RoomWidgetStopEffectMessage.const_1004:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1165:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_847:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_995:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_511:
            ...
            case RoomWidgetGetSettingsMessage.const_957:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_438,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_897:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_438,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_965:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_438,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1266:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_642));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_126:
               ...
               break;
            case HabboHelpTutorialEvent.const_844:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_600));
         }
      }
