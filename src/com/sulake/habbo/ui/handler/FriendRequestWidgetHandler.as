package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_812);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_900);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1007);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_812:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_900:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1007:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_176);
         _loc1_.push(FriendRequestEvent.const_60);
         _loc1_.push(FriendRequestEvent.const_234);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_176:
            ...
            case FriendRequestEvent.const_234:
