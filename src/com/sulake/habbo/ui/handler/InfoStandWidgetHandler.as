package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_243.events.addEventListener(NowPlayingEvent.const_106,this.onNowPlayingChanged);
            this.var_243.events.addEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_189,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_224,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_198,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_114,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_189,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_224,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_198,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_114,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_243 != null)
         {
            this.var_243.events.removeEventListener(NowPlayingEvent.const_106,this.onNowPlayingChanged);
            this.var_243.events.removeEventListener(SongInfoReceivedEvent.const_95,this.onSongInfoReceivedEvent);
            this.var_243 = null;
         }
         this.var_1152 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_621);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_735);
         _loc1_.push(RoomWidgetUserActionMessage.const_568);
         _loc1_.push(RoomWidgetUserActionMessage.const_629);
         _loc1_.push(RoomWidgetUserActionMessage.const_650);
         _loc1_.push(RoomWidgetUserActionMessage.const_602);
         _loc1_.push(RoomWidgetUserActionMessage.const_624);
         _loc1_.push(RoomWidgetUserActionMessage.const_455);
         _loc1_.push(RoomWidgetUserActionMessage.const_516);
         _loc1_.push(RoomWidgetUserActionMessage.const_653);
         _loc1_.push(RoomWidgetUserActionMessage.const_647);
         _loc1_.push(RoomWidgetUserActionMessage.const_660);
         _loc1_.push(RoomWidgetUserActionMessage.const_917);
         _loc1_.push(RoomWidgetFurniActionMessage.const_282);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1024);
         _loc1_.push(RoomWidgetFurniActionMessage.const_826);
         _loc1_.push(RoomWidgetFurniActionMessage.const_949);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1274);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_752);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_1005);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_948);
         _loc1_.push(RoomWidgetUserActionMessage.const_639);
         _loc1_.push(RoomWidgetUserActionMessage.const_547);
         _loc1_.push(RoomWidgetUserActionMessage.const_526);
         _loc1_.push(RoomWidgetUserActionMessage.const_1975);
         _loc1_.push(RoomWidgetPetCommandMessage.const_634);
         _loc1_.push(RoomWidgetPetCommandMessage.const_1014);
         _loc1_.push(RoomWidgetUserActionMessage.const_500);
         _loc1_.push(RoomWidgetUserActionMessage.const_283);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_769);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_639)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_283 || param1.type == RoomWidgetUserActionMessage.const_500 || param1.type == RoomWidgetUserActionMessage.const_526)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_500:
               ...
               break;
            case RoomWidgetUserActionMessage.const_650:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1220,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_624:
               ...
               break;
            case RoomWidgetUserActionMessage.const_455:
            ...
            case RoomWidgetUserActionMessage.const_516:
               ...
               break;
            case RoomWidgetUserActionMessage.const_653:
            ...
            case RoomWidgetUserActionMessage.const_660:
               ...
               break;
            case RoomWidgetUserActionMessage.const_917:
            ...
            case RoomWidgetUserActionMessage.const_526:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1024:
            ...
            case RoomWidgetRoomTagSearchMessage.const_752:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_1005:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_948:
               ...
               break;
            case RoomWidgetUserActionMessage.const_639:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_300);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_354);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_394) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_394);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_973) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1206;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_300);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1314);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1401);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_510)
                  {
                     _loc30_ = this.var_243.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_243.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_223)
               {
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_349);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_115)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_164)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_856);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_829;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_776;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1810);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_169];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_169:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_856);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_243.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_450,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_420,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
