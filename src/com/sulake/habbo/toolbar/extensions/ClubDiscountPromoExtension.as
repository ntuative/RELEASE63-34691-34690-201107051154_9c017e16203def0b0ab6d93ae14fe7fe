package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_1519:int = 13;
      
      private static const const_1124:int = 14;
      
      private static const const_1520:uint = 16777215;
      
      private static const const_1518:uint = 12247545;
      ...
      private var var_642:IExtensionView;
      ...
      private var var_920:BitmapData;
      
      private var var_1400:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_642 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_369,this.onClubChanged);
         }
      }
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_91)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_920 = _loc5_.content as BitmapData;
                     if(this.var_920)
                     {
                        this.var_91.bitmap = this.var_920.clone();
                     }
                  }
                  this.var_91.visible = false;
               }
               this.var_1400 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1400)
               {
                  this.var_1400.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1400.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.method_9);
                  this.var_1400.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_642)
            {
               this.var_642.detachExtension(const_728);
               this.var_642 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_369,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_642.attachExtension(const_728,this._view,ExtensionFixedSlotsEnum.const_1754);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_743 = new Timer(15000);
            this.var_743.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_743.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_2185 = this._view.width - 7 - this.var_91.bitmap.width;
         this.var_1684 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_731 = new Timer(25,26);
         this.var_731.addEventListener(TimerEvent.TIMER,this.onAnimationTimer);
         this.var_731.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationTimerComplete);
         this.var_731.start();
      }
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_91.x = 3 + this.var_1684 / 20 * this.var_2185;
         if(this.var_91.x > this.var_2185)
         {
            _loc2_ = this._view.width - 4 - this.var_91.x;
            _loc3_ = new BitmapData(_loc2_,this.var_920.height);
            _loc3_.copyPixels(this.var_920,new Rectangle(0,0,_loc2_,this.var_920.height),new Point(0,0));
      ...
      private function method_9(param1:WindowMouseEvent) : void
      {
         var _loc2_:* = null;
         if(this._view)
         {
            _loc2_ = this._view.findChildByName("promo_text") as ITextWindow;
            _loc2_.textColor = const_1518;
         }
      }
