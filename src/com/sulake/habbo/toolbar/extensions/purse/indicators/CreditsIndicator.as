package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1506:uint = 4291993382;
      
      private static const const_1505:uint = 4290807040;
      
      private static const const_472:Array = ["icon_credit_0_png","icon_credit_1_png","icon_credit_2_png","icon_credit_3_png","icon_credit_4_png","icon_credit_5_png","icon_credit_6_png"];
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_123,this.onCreditBalance);
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1924 != -1)
         {
            if(this.var_1924 > param1.balance)
            {
