package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1506:uint = 4285767869;
      
      private static const const_1505:uint = 4283664040;
      
      private static const const_472:Array = ["icon_pixel_0_png","icon_pixel_1_png","icon_pixel_2_png","icon_pixel_3_png"];
      ...
      public function PixelsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.iconAnimationSequence = const_472.concat(const_472);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.pixels.zero.amount.text","Get");
         createWindow("purse_indicator_pixels_xml",const_472[0]);
         this.setAmount(0);
      }
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1830);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1938 != 0)
         {
            if(this.var_1938 > param1.balance)
            {
