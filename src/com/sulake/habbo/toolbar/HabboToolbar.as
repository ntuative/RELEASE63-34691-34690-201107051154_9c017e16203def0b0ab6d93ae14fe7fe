package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1455:String = "purse";
      
      private static const const_1454:String = "extra_tools";
      ...
      private var var_641:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1204:PurseExtension;
      
      private var var_1488:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_642:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_281.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_281 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
            this.var_281.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","ICaption") == "true")
         {
            this.var_642 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_642)
            {
               this.var_1204 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_641 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1488 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_642.attachExtension(const_1455,this.var_1204.window,ExtensionFixedSlotsEnum.const_1859);
               this.var_642.attachExtension(const_1454,this.var_641.window,ExtensionFixedSlotsEnum.const_1784);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_641.showRoomInfo();
         }
         else
         {
            this.var_641.hideRoomInfo();
         }
      }
