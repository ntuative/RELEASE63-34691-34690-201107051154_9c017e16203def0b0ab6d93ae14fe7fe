package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1059:Boolean = false;
      
      private static const const_682:String = "Navigation";
      
      private static const const_681:String = "Friend Bar";
      
      private static const const_1439:String = "go.friendbar";
      
      private static const const_1441:String = "chat_btn_click";
      
      private static const const_1440:String = "find_friends_btn_click";
      
      private static const const_1062:String = "Toolbar";
      
      private static const const_1061:String = "open";
      
      private static const const_1060:String = "close";
      
      private static const const_1438:String = "FRIENDLIST";
      
      private static const const_1442:String = "MESSENGER";
       
      
      private var var_964:IHabboConfigurationManager;
      
      private var var_93:IHabboCommunicationManager;
      
      private var var_83:IHabboFriendList;
      
      private var var_213:IHabboMessenger;
      
      private var var_635:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_964)
            {
               this.var_964.release(new IIDHabboConfigurationManager());
               this.var_964 = null;
            }
            if(this.var_93)
            {
            ...
            if(this.var_83)
            {
               if(!this.var_83.disposed)
               {
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_234,this.onFriendRequestEvent);
               }
               this.var_83.release(new IIDHabboFriendList());
               this.var_83 = null;
            }
            if(this.var_213)
            {
               this.var_213.release(new IIDHabboMessenger());
               this.var_213 = null;
            }
            if(this.var_635)
            {
               this.var_635.release(new IIDHabboEventStream());
               this.var_635 = null;
            }
            this.var_113 = null;
      ...
      {
         return this.var_326.getValue(param1);
      }
      ...
      {
         return !!this.var_119 ? int(this.var_119.length) : 0;
      }
      
      public function getFriendRequestAt(param1:int) : FriendRequest
      {
         return !!this.var_119 ? this.var_119[param1] : null;
      }
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               this.var_83.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_119 = [];
         this.var_83.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               this.var_83.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_119 = [];
         this.var_83.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestUpdateEvent());
      }
      ...
      private function removeFriendRequest(param1:int) : void
      {
         ...
         if(this.var_119)
         {
            for each(_loc2_ in this.var_119)
            {
               if(_loc2_.id == param1)
               {
                  this.var_119.splice(this.var_119.indexOf(_loc2_),1);
                  events.dispatchEvent(new FriendRequestUpdateEvent());
                  return;
               }
            }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_682,const_681,const_1439));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_213)
         {
            this.var_213.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_682,const_681,const_1441));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_682,const_681,const_1440));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               if(!this.var_83.isOpen())
               {
                  if(this.var_119.length > 0)
                  {
                     this.var_83.openFriendRequests();
                  }
                  else
                  {
                     this.var_83.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_83.mainWindow;
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1062,const_1438,!!this.var_83.isOpen() ? const_1061 : const_1060));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_213)
         {
            ...
            {
               this.var_213.toggleMessenger();
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1062,const_1442,!!this.var_213.isOpen() ? const_1061 : const_1060));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_635)
         {
            if(!this.var_635.disposed)
            {
               this.var_635.visible = !this.var_635.visible;
            }
         }
      }
      ...
      {
         this.var_964 = param2 as IHabboConfigurationManager;
         this.var_2417 = this.var_964.getBoolean("friendbar.notifications.enabled",false);
         this.var_1811 = this.var_964.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_213 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_635 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_83 = param2 as IHabboFriendList;
         this.var_83.events.addEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
         this.var_83.events.addEventListener(FriendRequestEvent.const_234,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_326.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_326.remove(_loc8_);
               this.var_113.splice(this.var_113.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_326.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_316)
            {
               ...
               this.var_326.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_316)
            {
               if(this.var_326.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_113 = !!const_316 ? this.sortByNameAndOnlineStatus(this.var_113) : this.sortByName(this.var_113);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         if(this.var_1811)
         {
            ...
            this.var_119.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName,_loc2_.figureString));
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         if(this.var_1811)
         {
            ...
            {
               this.var_119.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName,_loc3_.figureString));
            }
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_783 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_213)
         {
            if(this.var_213.isOpen())
            {
               _loc4_ = this.var_213.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_783)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_783));
            this.makeNotification(String(this.var_783),FriendNotification.const_418,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_783 = _loc2_.senderId;
         if(this.var_213 && !this.var_213.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_783));
            this.makeNotification(String(this.var_783),FriendNotification.const_418,null,true,false);
         }
      }
