package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2051:String = "friend_request_tab_xml";
      ...
      protected static const const_1032:String = "click_region_reject";
      
      protected static const REGION_REJECT_TEXT:String = "link_reject";
      
      private static const const_77:uint = 16435481;
      
      private static const const_1074:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1682:uint = 16777215;
      
      private static var var_1655:FriendRequestTab;
      ...
      public function FriendRequestTab()
      {
         ...
         if(_window)
         {
            _window.findChildByName(const_466).visible = false;
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1655 ? var_1655 : new FriendRequestTab();
         _loc2_.var_169 = false;
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               _loc3_ = IBitmapWrapperWindow(_loc2_._window.findChildByName(const_315));
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2051).content as XML) as IWindowContainer;
         ...
         var _loc5_:IBubbleWindow = _loc1_.findChildByName(const_466) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_350,WindowStyle.const_105,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_459,WindowStyle.const_105,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2052:
                  var_356.acceptFriendRequest(var_170.id);
                  break;
               case const_1411:
                  if(selected)
                  {
                  ...
                  break;
               case const_1032:
                  var_356.declineFriendRequest(var_170.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1032)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1682;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(!disposed)
         {
            if(friend)
            {
               ...
               {
                  _loc3_ = _window.findChildByName(const_315) as IBitmapWrapperWindow;
                  if(_loc3_)
                  {
