package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1463:String = "add_friends_tab_xml";
      
      private static const const_1462:String = "find_friends_icon_png";
      
      private static var var_975:int = -1;
      
      private static const const_77:uint = 6907230;
      
      private static const const_1074:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_469:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_469.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1463).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_464));
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_469.indexOf(param1) == -1)
            {
               const_469.push(param1);
            }
         }
      }
