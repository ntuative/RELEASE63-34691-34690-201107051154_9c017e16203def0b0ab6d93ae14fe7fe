package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1555:String = "entity_xml";
      
      private static const const_1556:String = "facebook_piece_xml";
      
      private static const const_1553:String = "controls_piece_xml";
      
      protected static const const_1031:String = "pieces";
      
      protected static const const_385:String = "icons";
      
      protected static const const_464:String = "header";
      
      protected static const const_1413:String = "facebook";
      
      protected static const const_1412:String = "controls";
      
      protected static const const_315:String = "canvas";
      
      protected static const const_711:String = "name";
      
      protected static const const_1065:String = "btn_message";
      
      protected static const const_1030:String = "icon_message";
      
      protected static const const_1414:String = "btn_visit";
      ...
      private static const const_77:uint = 10338138;
      
      private static const const_1074:uint = 13891476;
      
      private static const const_1102:String = null;
      
      private static const const_706:String = "icon_tag_notify";
      ...
      private static const const_478:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1031));
         _loc3_ = _loc2_.getListItemByName(const_1413) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1412) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1031));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               ...
               _loc3_.name = const_1413;
               _loc6_ = _loc3_.getChildByName(const_711) as ITextWindow;
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1553).content as XML) as IWindowContainer;
               _loc3_.name = const_1412;
               _loc8_ = _loc3_.getChildByName(const_1065);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1414);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_170)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1031)).getListItemByName(const_464) as IWindowContainer;
            _loc1_.findChildByName(const_711).caption = this.var_170.name;
            var_2218.crop(_loc1_.getChildByName(const_711) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_315));
            _loc2_.bitmap = var_503.getAvatarFaceBitmap(this.var_170.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_478.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1555).content as XML) as IWindowContainer;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_478.indexOf(param1) == -1)
            {
               const_478.push(param1);
            }
         }
      }
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1065:
               case const_1030:
                  this.removeNotificationToken(FriendNotification.const_418,true);
                  if(var_356 && this.var_170)
                  {
                     var_356.startConversation(this.var_170.id);
                     this.deselect(true);
                     if(param1.window.name == const_1030)
                     {
               ...
               case const_1414:
                  if(var_356 && this.var_170)
                  {
                     var_356.followToRoom(this.var_170.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1102;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1184:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2207);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_706;
               break;
            case FriendNotification.const_1289:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2207);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_706;
               break;
            case FriendNotification.const_418:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1030;
