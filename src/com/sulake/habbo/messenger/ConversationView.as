package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1680:int = 10;
      
      private static const const_1150:int = 100;
      
      private static const const_1679:int = 20;
       
      
      private var var_158:HabboMessenger;
      
      private var var_2962:IScrollbarWindow;
      
      private var var_2131:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_593:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_158 = param1;
         this.var_2131 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2962 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1150 + const_1679)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1680;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_593 == null || _loc1_.id != this.var_593.id)
         {
            this.var_593 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_593.followingAllowed)
         {
            this.var_2131.enable();
         }
         else
         {
            this.var_2131.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_593.messages.length - const_1150);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_593.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_593.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_755 || param3.type == Message.const_759 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_593.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_158.send(new FollowFriendMessageComposer(this.var_593.id));
      ...
      {
         if(param1 == Message.const_755)
         {
            return 4294967295;
         }
         if(param1 == Message.const_759)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1275)
         {
            return 4294927974;
         }
         if(param1 == Message.const_879)
         {
            return 4293454056;
         }
         if(param1 == Message.const_819)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1187)
         {
            return 4288269465;
         }
         return 4291611852;
