package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1063:ITextFieldWindow;
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1094 = new ConversationsTabView(this.var_158,this.var_16);
         this.var_1094.refresh();
         this.var_1063 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_1063.addEventListener(WindowKeyboardEvent.const_184,this.onMessageInput);
         this.var_1638 = new ConversationView(this.var_158,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_895,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1186,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_1063.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_1063.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_1063.text;
         ...
         this.var_1063.text = "";
         this.var_158.conversations.addMessageAndUpdateView(new Message(Message.const_755,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
