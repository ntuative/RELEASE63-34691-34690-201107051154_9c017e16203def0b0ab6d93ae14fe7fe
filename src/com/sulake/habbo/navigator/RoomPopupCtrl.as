package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_129:GuestRoomData;
      
      private var var_2286:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2286 = new RoomThumbnailRenderer(param1);
         this.var_1105 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_199,this.var_129);
         if(this.var_129.ownerName != "" && this.var_129.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_199,!!this.var_129.event ? this.getEventCtg(this.var_129.categoryId) : this.getRoomCtg(this.var_129.categoryId));
         this.refreshRoomDesc(this.var_199,this.var_129);
         this.refreshExtraCont();
         this.refreshInfo(this.var_199,"trading_allowed",this.var_129.allowTrading);
         this.refreshInfo(this.var_199,"doormode_doorbell",this.var_129.doorMode == 1);
         this.refreshInfo(this.var_199,"doormode_password",this.var_129.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_199,this.var_129.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1105.refreshTags(_loc1_,this.var_129.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_129.score);
         if(this.var_129.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_129.eventCreationTime);
         }
         this.var_2286.refreshThumbnail(_loc1_,this.var_129.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_266,Tabs.const_415,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
