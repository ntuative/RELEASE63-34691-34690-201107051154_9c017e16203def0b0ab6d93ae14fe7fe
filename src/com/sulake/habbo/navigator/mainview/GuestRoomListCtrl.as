package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_552:RoomPopupCtrl;
      
      private var var_607:IScrollbarWindow;
      
      private var var_1237:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_552 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1237 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_607 = IScrollbarWindow(this.var_194.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_194.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_183,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_2000,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_139,null,0);
         this.refreshRoomName(param1,param2);
         this.var_1237.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_552.visible && this.var_2730)
         {
            return;
         }
         ...
         this.var_552.room = _loc4_;
         this.var_552.showPopup(_loc2_);
      }
      ...
      private function onMouseClick(param1:WindowEvent) : void
      {
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            {
               case RoomSettingsFlatInfo.const_139:
      ...
      {
         var _loc2_:int = 0;
         if(this.var_1563 != null)
         {
            _loc2_ = this.var_1563.tags[0];
            this.var_1563.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2729 - _loc2_.stageX);
         this.var_2729 = _loc2_.stageX;
         this.var_2730 = _loc3_ > 2;
      }
   }
}
