package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_152 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_152.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_152 != null)
         {
            this.var_152.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_436);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_886);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_436,"" + _loc3_);
         }
         if(this.var_152)
         {
            this._navigator.trackNavigationDataPoint(this.var_152.enumerateSelection()[this.var_152.selection],"category.view");
         }
      }
