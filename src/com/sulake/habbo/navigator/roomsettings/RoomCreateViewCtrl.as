package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1179:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1180:RoomLayout;
      
      private var var_629:Timer;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_629 = new Timer(100);
         this.var_629.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_45 = new Array();
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,540,"t"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,512,"w"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,396,"x"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,440,"y"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,456,"z"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_41,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_629)
         {
            this.var_629.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_629.reset();
            this.var_629 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1180.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1774 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1774 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1179 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_194.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1179.goBackToInitialState();
         this.var_1179.input.textBackgroundColor = 4294967295;
         this.var_1180 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         {
            if(this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_41))
            {
               _loc5_ = null;
            }
            else
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            ...
            case HabboClubLevelEnum.const_41:
               return this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_41);
            default:
               return false;
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_73,HabboWindowStyle.const_31,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1179.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1179.getText();
         var _loc3_:String = "model_" + this.var_1180.name;
