package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_367.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_367)
         {
            this.var_367.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_367.reset();
            this.var_367 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._navigator.getXmlWindow(this.var_1145));
         ...
         this.var_58.x = _loc2_.x + this.var_2315 + param1.width;
