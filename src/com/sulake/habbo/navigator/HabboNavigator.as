package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_318:MainViewCtrl;
      
      private var var_616:RoomInfoViewCtrl;
      
      private var var_1167:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_476:Tabs;
      ...
      private var var_1015:GuestRoomPasswordInput;
      
      private var var_354:GuestRoomDoorbell;
      
      private var var_1168:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2285 = new Array();
         ...
         this.var_318 = new MainViewCtrl(this);
         this.var_616 = new RoomInfoViewCtrl(this);
         this.var_1167 = new RoomCreateViewCtrl(this);
         this.var_2286 = new RoomThumbnailRenderer(this);
         this.var_1015 = new GuestRoomPasswordInput(this);
         this.var_354 = new GuestRoomDoorbell(this);
         this.var_476 = new Tabs(this);
         this.var_1168 = new OfficialRoomEntryManager(this);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_318.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_138.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_318.startSearch(Tabs.const_266,Tabs.const_649,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_318.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_318.startSearch(Tabs.const_261,Tabs.const_272);
         this.var_476.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
