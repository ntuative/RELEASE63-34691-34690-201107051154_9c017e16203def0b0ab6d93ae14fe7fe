package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1747:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1745 = this._navigator.getButtonImage(this.var_1748);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1747 == null)
         {
            ...
            this.var_1747 = new Rectangle(this.var_1445,this.var_1445,_loc1_.width - 2 * this.var_1445,_loc1_.height - 2 * this.var_1445);
         }
         this.var_624.bitmap.fillRect(this.var_624.bitmap.rect,4281545523);
         this.var_624.bitmap.fillRect(this.var_1747,4284900966);
         this.copyTo(this.var_624.bitmap);
         if(this._selected)
         {
            this.var_624.bitmap.copyPixels(this.var_1746,this.var_1746.rect,new Point(0,0),null,null,true);
         }
