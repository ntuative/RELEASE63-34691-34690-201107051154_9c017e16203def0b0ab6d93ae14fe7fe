package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_814:TextFieldManager;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:IWindowContainer)
      {
         ...
         this.var_814 = new TextFieldManager(this._navigator,_loc3_,25,this.searchRooms,this._navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = this.var_814.getText();
         if(_loc1_ == "")
         {
            return;
         }
         this._navigator.mainViewCtrl.startSearch(Tabs.const_266,Tabs.const_415,_loc1_);
