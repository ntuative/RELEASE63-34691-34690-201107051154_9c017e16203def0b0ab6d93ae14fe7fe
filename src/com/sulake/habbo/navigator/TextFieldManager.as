package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         {
            this.var_615 = true;
            this.var_1487 = param5;
            this.var_69.text = param5;
         }
         Util.setProcDirectly(this.var_69,this.onInputClick);
         this.var_69.addEventListener(WindowKeyboardEvent.const_184,this.checkEnterPress);
         this.var_69.addEventListener(WindowEvent.const_116,this.checkMaxLen);
         this._orgTextBackground = this.var_69.textBackground;
         this.var_2276 = this.var_69.textBackgroundColor;
      ...
      public function restoreBackground() : void
      {
         ...
         this.var_69.textBackgroundColor = this.var_2276;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1487;
            this.var_615 = true;
         }
         else
         {
      ...
      {
         return !this.var_615 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2275;
         this.var_615 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_1721)
         {
            this.var_69.text = _loc2_.substring(0,this.var_1721);
         }
      }
   }
}
