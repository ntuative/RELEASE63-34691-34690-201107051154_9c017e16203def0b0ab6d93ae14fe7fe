package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_328:String = "TUI_NAME_VIEW";
      
      public static const const_421:String = "TUI_CLOTHES_VIEW";
      
      public static const const_623:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_422:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_585,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_673,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_642,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_373,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1371 && this.var_1370 && this.var_1658;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_585,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_673,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_642,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_373,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_54 == null || this.var_54.id == const_98)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_585:
               this.var_1658 = true;
               if(this.var_54 != null && this.var_54.id == const_623)
               {
                  this.showView(const_98);
               }
               break;
            case HabboHelpTutorialEvent.const_673:
               if(this.var_54 != null && this.var_54.id == const_421)
               {
                  this.var_2141 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_642:
               if(this.var_2141)
               {
                  this.var_2141 = false;
                  this.showView(const_98);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2681 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_328:
               ...
               if(this.var_422 == null)
               {
                  this.var_422 = new NameChangeView(this);
               }
               this.var_422.showMainView();
               this.prepareForTutorial();
               break;
            case const_421:
         ...
         this._window.height = _loc2_.height + this.var_2680;
         this._window.width = _loc2_.width + this.var_2681;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_126));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_328 || this.var_54.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1371 = true;
         if(this.var_54 != null && (this.var_54.id == const_421 || this.var_54.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_422.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_502)
         {
            this.var_422.checkedName = _loc2_.name;
         }
         else
         {
            this.var_422.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
